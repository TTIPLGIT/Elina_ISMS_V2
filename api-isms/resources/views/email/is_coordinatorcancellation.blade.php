...
<body>
    ...
    We are pleased to inform you that you have been Cancelled as IS-Coordinator1: {{$data['is_coordinator1']}} and IS-Coordinator2: {{$data['is_coordinator2']}} for {{$data['child_name']}}<br /><br />
