...
class newinqueryadmin extends Mailable
{
  ...
  public function build()
  {
    ...
    return $this->from($email_id)->subject('New Elina Lead Registration - '.$data['name'] )->view('email.newinqueryadmin')->with('data', $this->data);
