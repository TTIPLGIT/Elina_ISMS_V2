...
class ScheduleOnlineMeeting extends Mailable
{
  ...
  public function build()
  {
    ...
    return $this->from($email_id)->subject('Confirmation of Scheduled Online Meeting and Contact Details')->view('email.ScheduleOnlineMeeting')->with('data', $this->data)->attach($attachment);
