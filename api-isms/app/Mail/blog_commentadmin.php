...
class blog_commentadmin extends Mailable
{
  ...
  public function build()
  {
    ...
    return $this->from($email_id)->subject('New comment in the blog section - ' . $data['name'])->view('email.blog_commentadmin')->with('data', $this->data);
