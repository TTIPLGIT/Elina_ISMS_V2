...
class blog_comment extends Mailable
{
  ...
  public function build()
  {
    ...
    return $this->from($email_id)->subject('Re: Appreciation for Your Blog Engagement and Further Assistance')->view('email.blog_comment')->with('data', $this->data);
