...
class SchedulePhoneCall extends Mailable
{
  ...
  public function build()
  {
    ...
    return $this->from($email_id)->subject('Confirmation of Scheduled Phone Call and Contact Details')->view('email.SchedulePhoneCall')->with('data', $this->data)->attach($attachment);
