      ...
      try {
        ...
        if ($screen_check == []) { 
           ...
           $role_name=DB::select("SELECT ur.role_name,us.name FROM uam_roles AS ur
            ...
            $this->admin_notification('UAM', 'Create' , 'uam_screens' , $uam_screen_id ,$input['screen_name'], 'UAM Screens has been Successfully Created' );
...
$this->auditLog('uam_screens', $input['screen_id'], 'Updated', "Updated screen by $name", auth()->user()->id, NOW(),$role_name_fetch);
$this->admin_notification('UAM', 'Updated' , 'uam_screens' , $input['screen_id'] ,$input['screen_name'], 'UAM Screens has been Successfully Updated' );
...
public function data_delete($id)
{
    try{
        ...
        //   $role_name_fetch=$role_name[0]->role_name;
          $this->auditLog('uam_screens', $id, 'Delete', 'Deleted the uam screen', auth()->user()->id, NOW(),'');             
