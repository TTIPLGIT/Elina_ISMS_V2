...
<div class="main-content">
    <section class="section">
        <div class="section-body mt-2">
            <form action="{{route('business.affiliate.store')}}" method="POST" id="schoolRegistrationForm">
                @csrf 
                    ...
                    <div class="card-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="schoolName" name="schoolName" class="form-control" placeholder="Enter school name">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="schoolAddress" name="schoolAddress" class="form-control" placeholder="Enter school address"></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="contactName" name="contactName" class="form-control" placeholder="Enter contact person name">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="contactPosition" name="contactPosition" class="form-control" placeholder="Enter position or role">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="tel" id="contactPhone" name="contactPhone" class="form-control" placeholder="Enter phone number">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="contactEmail" name="contactEmail" class="form-control" placeholder="Enter email address">
