        ...
        <div class="col-lg-12 col-md-12">
            <div class="" style="height:100%;">
                <div id="content">
                    ...
                    <form class="formValidationDiv" action="{{ route('questionnaire_for_child.index') }}" method="" id="divQuestionnaireForm">
                        {{ csrf_field() }}
                        <div class="card card_design">
                            <input type="hidden" value="10" id="questionnaire_initiation_id" name="questionnaire_initiation_id">
                            ...
                            <div id="Step1" class="tabcontent pagination_one page_lable">
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_001">
                                    <div class="form-group pagination-element1"><label class="control-label  required">1.Name of the child</label><input class="form-control pagination1" type="text" id="Question_23_001" name="Question_23_001" placeholder="Your Answer" data-required="1"><i class="bar"></i></div>
                                </div>
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_001">
                                    <div class="form-group pagination-element1"><label class="control-label  required">2.Name of the person filling this form</label><input class="form-control pagination1" type="text" id="Question_23_001" name="Question_23_001" placeholder="Your Answer" data-required="1"><i class="bar"></i></div>
                                </div>
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_002">
                                    <div class="form-group pagination-element1"><label class="control-label  required">3.Relationship to the child</label><input class="form-control pagination1" type="text" id="Question_23_002" name="Question_23_002" placeholder="Your Answer" data-required="1"><i class="bar"></i></div>
                                </div>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_003">
                                    <div class="form-group pagination-element1"><label class="control-label  required">4.My child has trouble following multi-step instructions</label><select class="documentCategory pagination1" data-required="1" name="Question_23_003" id="Question_23_003" style="width: 50%;">
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_004">
                                    <div class="form-group pagination-element1"><label class="control-label  required">5.My child acts like or reports being bored</label><select class="documentCategory pagination1" data-required="1" name="Question_23_004" id="Question_23_004" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_005">
                                    <div class="form-group pagination-element1"><label class="control-label  required">6.My child is easily distracted by noises, activities, and other external stimulation</label><select class="documentCategory pagination1" data-required="1" name="Question_23_005" id="Question_23_005" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_006">
                                    <div class="form-group pagination-element1"><label class="control-label  required">7.My child doesn't procrastinate</label><select class="documentCategory pagination1" data-required="1" name="Question_23_006" id="Question_23_006" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_007">
                                    <div class="form-group pagination-element1"><label class="control-label  required">8.My child has difficulty switching from one activity to another</label><select class="documentCategory pagination1" data-required="1" name="Question_23_007" id="Question_23_007" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_008">
                                    <div class="form-group pagination-element1"><label class="control-label  required">9.My child can disagree with friends and still like them</label><select class="documentCategory pagination1" data-required="1" name="Question_23_008" id="Question_23_008" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_009">
                                    <div class="form-group pagination-element1"><label class="control-label  required">10.My child requires constant prompts to continue paying attention</label><select class="documentCategory pagination1" data-required="1" name="Question_23_009" id="Question_23_009" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_005">
                                    <div class="form-group pagination-element1"><label class="control-label  required">11.My child is easily distracted by noises, activities, and other external stimulation</label><select class="documentCategory pagination1" data-required="1" name="Question_23_005" id="Question_23_005" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_006">
                                    <div class="form-group pagination-element1"><label class="control-label  required">12.My child doesn't procrastinate</label><select class="documentCategory pagination1" data-required="1" name="Question_23_006" id="Question_23_006" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_007">
                                    <div class="form-group pagination-element1"><label class="control-label  required">13.My child has difficulty switching from one activity to another</label><select class="documentCategory pagination1" data-required="1" name="Question_23_007" id="Question_23_007" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_008">
                                    <div class="form-group pagination-element1"><label class="control-label  required">14.My child can disagree with friends and still like them</label><select class="documentCategory pagination1" data-required="1" name="Question_23_008" id="Question_23_008" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_009">
                                    <div class="form-group pagination-element1"><label class="control-label  required">15.My child requires constant prompts to continue paying attention</label><select class="documentCategory pagination1" data-required="1" name="Question_23_009" id="Question_23_009" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_010">
                                    <div class="form-group pagination-element1"><label class="control-label  required">16.My child can use a planner or a calendar to plan long and short-term assignments</label><select class="documentCategory pagination1" data-required="1" name="Question_23_010" id="Question_23_010" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_011">
                                    <div class="form-group pagination-element1"><label class="control-label  required">17.My child has difficulty making transitions from one activity to another</label><select class="documentCategory pagination1" data-required="1" name="Question_23_011" id="Question_23_011" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_012">
                                    <div class="form-group pagination-element1"><label class="control-label  required">18.My child makes simple errors in math such as mistaking a plus for a minus sign</label><select class="documentCategory pagination1" data-required="1" name="Question_23_012" id="Question_23_012" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_013">
                                    <div class="form-group pagination-element1"><label class="control-label  required">19.My child lacks caution in activities such as crossing the street, riding bikes, or using tools</label><select class="documentCategory pagination1" data-required="1" name="Question_23_013" id="Question_23_013" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_014">
                                    <div class="form-group pagination-element1"><label class="control-label  required">20.My child requires ongoing prompts to begin and then continue effects</label><select class="documentCategory pagination1" data-required="1" name="Question_23_014" id="Question_23_014" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_015">
                                    <div class="form-group pagination-element1"><label class="control-label  required">21.My child lacks motivation to start on home and school tasks</label><select class="documentCategory pagination1" data-required="1" name="Question_23_015" id="Question_23_015" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_016">
                                    <div class="form-group pagination-element1"><label class="control-label  required">22.My child wastes time at the beginning of tests, chores, or activities</label><select class="documentCategory pagination1" data-required="1" name="Question_23_016" id="Question_23_016" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_017">
                                    <div class="form-group pagination-element1"><label class="control-label  required">23.My child jumps into activities without reading directions</label><select class="documentCategory pagination1" data-required="1" name="Question_23_017" id="Question_23_017" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_018">
                                    <div class="form-group pagination-element1"><label class="control-label  required">24.My child experiences problems in determining priorities, destinations, or goals</label><select class="documentCategory pagination1" data-required="1" name="Question_23_018" id="Question_23_018" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_019">
                                    <div class="form-group pagination-element1"><label class="control-label  required">25.My child has difficulty with step-by-step directions</label><select class="documentCategory pagination1" data-required="1" name="Question_23_019" id="Question_23_019" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_020">
                                    <div class="form-group pagination-element1"><label class="control-label  required">26.My child gives up quickly when learning new tasks</label><select class="documentCategory pagination1" data-required="1" name="Question_23_020" id="Question_23_020" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                            ...
                            <div id="Step2" class="tabcontent pagination_two page_lable">
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_021">
                                    <div class="form-group pagination-element2">
                                        ...
                                        <select class="documentCategory pagination1" data-required="1" name="Question_23_021" id="Question_23_021" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
                                ...
                                <div class="col-md-12 divClass newQuestion" id="divQuestion_23_022">
                                    <div class="form-group pagination-element2"><label class="control-label  required">28.My child has many unfinished projects</label><select class="documentCategory pagination2" data-required="1" name="Question_23_022" id="Question_23_022" style="width: 50%;">
                                            <option value=""> Choose </option>
                                            <option value="Almost Never">Almost Never</option>
                                            <option value="Sometimes">Sometimes</option>
                                            <option value="Frequently">Frequently</option>
...
<script>
    function save() {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You want to save this Questionnaire.',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                // Submit the form
                const message = "Questionnaire Saved Successfully";
                location.replace(`/questionnaire_for_child?message=${encodeURIComponent(message)}`);


            }
        });
        var form = document.getElementById('divQuestionnaireForm');
    ...
    function completed_questions() {
                ...
                if (type == 'text' || tag == 'TEXTAREA') {
                    ...
                    if (checkbox == null) {
                        ...
                        if (othersCheckbox != undefined) {
                            ...
                            if (mainQuestion.querySelector('label.required') != null) {
                                ...
                                subquestions.forEach(function(subquestion) {
                                    if (subquestion.parentNode.parentNode.querySelector('td:first-child') != null) {
        ...
        var incompCount = $(".incompCount").length;
        var newQuestion = $(".newQuestion").length;

        var newComp = newQuestion - incomp;
        var newIncomplete = incomp;
        var total = newQuestion;
        var ff = incomp + comp;
        document.getElementById('complete_question').value = newComp;
        // if (ff == divClass) {
...
<script>
    ...
    function QuestionnaireForm(DataFields) {
        ...
        for (let index = 0; index < DataFields.length; index++) {
            ...
            if (fieldTypeID == 1) {
                var textboxHtml = '<div class="col-md-12 divClass newQuestion" id="div' + fieldName + '"><div class="form-group pagination-element' + num + '">';
            ...
            if (fieldTypeID == 3) {
                ...
                var dropdownHtml = '<div class="col-md-12 divClass newQuestion" id="div' + fieldName + '"><div class="form-group pagination-element' + num + '">';
            ...
            //     if (otherOption == 1) {
            //         radioButtonHtml += '<div class="radio">';
            //         radioButtonHtml += '<label><input style="margin-right: 10px;" data-required="' + requiredQuestion + '" class="pagination' + num + ' Qradio" type="radio" name="' + fieldName + '" id="' + fieldName + '" value="Others" onclick="showInput(' + fieldName + ')"><i class="helper"></i> ' + (fieldID == '106' ? 'If yes, please mention the reason <br/>' : 'Others');
            //         radioButtonHtml += '<input type="text" class="otherOption' + fieldName + '" ' + (fieldID == '106' ? 'style="opacity: 1;display:none;width: 589px;margin: -2px 0px 0px 30px;' : 'style="opacity: 1;display:none;width: 589px;margin: -2px 0px 0px 80px;') + ' name="' + fieldName + '">';
            //         radioButtonHtml += '</label></div>';
            //     }
            //     // 
            ...
            if (fieldTypeID == 4) {
                ...
                var currentOption = [];
                var currentOption2 = [];
                var radioButtonHtml = '<div class="col-md-12 divClass newQuestion" id="div' + fieldName + '"><div class="form-radio pagination-element' + num + '">';
                radioButtonHtml += '<label class="control-label ' + (requiredQuestion == 1 ? ' required' : '') + '" style="margin-left: -30px;padding-bottom: 10px;">' + questionNum + ' . ' + fieldLabel + '</label><div class="radio">';
            ...
            if (fieldTypeID == 5) {
                ...
                var radioButtonHtml = '<div class="col-md-12 divClass newQuestion" id="div' + fieldName + '"><div class="form-group pagination-element' + num + '">';
                ...
                if (otherOption == 1) {
                    radioButtonHtml += '<label><input data-required="' + requiredQuestion + '" class="pagination' + num + ' otherOption' + fieldName + '" type="checkbox" id="' + fieldName + '" onclick="showInputOthers(' + fieldName + ')"><i class="helper"></i>Others';
                    radioButtonHtml += '<input type="text" data-required="' + requiredQuestion + '" class="otherField' + fieldName + '" style="width: 589px;width: 700px;opacity: 1;display:none;margin:-2px 0 0 90px;border: 1px solid;" name="' + fieldName + '[]"></label>';
                }
                radioButtonHtml += '</div></div>';
                $(stage).append(radioButtonHtml);
            }
                        ...
                        for (let index = 0; index < fieldOptions.length; index++) {
                            ...
                            if (question_details_id == fieldID)
                                if (questionValue == option_field_name) {
                                    // alert('asd');
                                    radioButtonHtml += '<td><input style="height: 15px;" class="pagination' + num + ' QSub" type="radio" name="' + fieldName + sub_questions_id + '" id="' + fieldName + '" value="' + option_field_name + '" checked data-required="' + requiredQuestion + '"></td>';
                                } else {
                                    radioButtonHtml += '<td><input style="height: 15px;" class="pagination' + num + ' QSub" type="radio" name="' + fieldName + sub_questions_id + '" id="' + fieldName + '" value="' + option_field_name + '" data-required="' + requiredQuestion + '"></td>';
                                }
                    ...
                    if (question_details_id == fieldID) {
                        ...
                        for (let index = 0; index < fieldOptions.length; index++) {
                            ...
                            if (question_details_id == fieldID)
                                if (questionValue == option_field_name) {
                                    // alert('asd');
                                    radioButtonHtml += '<td><input style="height: 15px;" class="pagination' + num + ' QSub" type="checkbox" name="' + fieldName + sub_questions_id + '[]" id="' + fieldName + '" value="' + option_field_name + '" data-required="' + requiredQuestion + '" checked></td>';
                                } else {
                                    radioButtonHtml += '<td><input style="height: 15px;" class="pagination' + num + ' QSub" type="checkbox" name="' + fieldName + sub_questions_id + '[]" id="' + fieldName + '" value="' + option_field_name + '" data-required="' + requiredQuestion + '"></td>';
                                }
                            // radioButtonHtml += '<td><input class="pagination' + num + '" type="radio" name="' + fieldName + sub_questions_id + '" id="' + fieldName + '" value="' + option_field_name + '"></td>';
                        }
                        radioButtonHtml += '</tr>'
