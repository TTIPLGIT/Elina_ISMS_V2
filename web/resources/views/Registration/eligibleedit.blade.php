<div class="modal fade" id="editeligeModal">
								...
								<div class="form-group">
									<div class="egc">
										...
										<div class="switch-field">
											...
											<input type="radio" id="radio-one1{{$loop->iteration}}" name="q[{{$loop->iteration}}][qans]" value="yes" {{ ($data['qans'] === "yes") ? "checked" : "" }} />
											<label for="radio-one1{{$loop->iteration}}">Yes</label>
											<input type="radio" id="radio-two1{{$loop->iteration}}" name="q[{{$loop->iteration}}][qans]" value="no" {{ ($data['qans'] === "no") ? "checked" : "" }} />
