                                        ...
                                        <div class="section-body mt-1">
                                            <div class="row">
                                                ...
                                                <label class="control-label">Work Experience:<span class="error-star" style="color:red;">*</span></label>
                                                        <input class="form-control default" type="text" id="we" name="we" required readonly value="" autocomplete="off">
                                                ...
                                                <div class="egc" style="display: flex;  align-items: center;">
                                                        ...
                                                        <input type="radio" id="radio-one12" name="wrqch" value="yes" required disabled onchange="radchange(this)" />
                                                        <label for="radio-one12">Yes</label>
                                                        <input type="radio" id="radio-two12" name="wrqch" value="no" required disabled onchange="radchange(this)" />
                                                        ...
                                                        <div class="row">
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wrq" type="text" oninput="input(this)" id="cpvw" readonly  name="wrq[cpvw]" autocomplete="off" >
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wrq" type="text" oninput="input(this)" id="teic" readonly name="wrq[teic]" autocomplete="off" >
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wrq" type="text" oninput="input(this)" id="acrr" readonly name="wrq[acrr]" autocomplete="off" >
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wrq" type="text" oninput="input(this)" id="imc" readonly name="wrq[imc]"  autocomplete="off" >
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default wrq" type="text" id="laal" name="wrq[laal]" readonly autocomplete="off">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                    </div>
...
<script type="application/javascript">
        ...
        for(var x=0; x < b.length; x++){
            document.getElementsByClassName('wrq')[z].setAttribute('required','required');
                ...
                for(j=0;j<wrel;j++){
                    var q = j+1;
                    $('#dynamic_fielde').append('<section class="input-box" id="row'+j+'"><div class="row clear remove_other'+j+' "> <div class="col-md-2"> <div class="form-group"> <label class="control-label">From Date:<span class="error-star" style="color:red;">*</span></label> <input class="form-control default indent wre" type="date" oninput="input(this)" id="fde'+q+'" name="wre['+j+'][fde]" required readonly autocomplete="off" > </div> </div> <div class="col-md-2"> <div class="form-group"> <label class="control-label">To Date:</label> <input class="form-control default indent wre" type="date" oninput="input(this)" id="tde'+q+'" name="wre['+j+'][tde]" readonly required autocomplete="off" > </div> </div> <div class="col-md-2"> <div class="form-group"> <label class="control-label"><span id="item_no_label"></span>Area of work:<span class="error-star" style="color:red;">*</span></label> <input class="form-control default wre" type="text" id="aow'+q+'" name="wre['+j+'][aow]" readonly required autocomplete="off"> </div> </div> <div class="col-md-3"> <div class="form-group"> <label class="control-label"><span id="item_label"></span>Employment/Practice:<span class="error-star" style="color:red;">*</span></label> <div class="switch-field" style="padding-left:12px"> <input type="radio" class="wre" id="radio-one'+j+'" name="wre['+j+'][ep]" value="employee" disabled required onchange="workchanges(this,'+q+')" /> <label for="radio-one'+j+'">Employment</label> <input type="radio" class="wre" id="radio-two'+j+'" name="wre['+j+'][ep]" value="practice" disabled required onchange="workchanges(this,'+q+')" /> <label for="radio-two'+j+'">Practice</label> </div> </div> </div> <div class="col-md-2" id="s1'+q+'" style="display:none"> <div class="form-group "> <label class="control-label"><span id="item_no_label1"></span>Designation:<span class="error-star"  style="color:red;">*</span></label> <input class="form-control default  wre" type="text" id="des'+q+'" name="wre['+j+'][des]" required readonly autocomplete="off"> </div> </div> <div class=" col-md-2" id="s2'+q+'" style="display:none"> <div class="form-group"> <label class="control-label"><span id="item_no_label2"></span>Exp in the relvt valuation:<span class="error-star" style="color:red;">*</span></label> <input class="form-control default wre" type="text" id="rel'+q+'" name="wre['+j+'][rel]" readonly required autocomplete="off"> </div> </div><div><button style="margin-top:30px" type="button" name="remove" id="'+j+'" class="btn btn-danger btn_remove">X</button></div></div></section>'); 
                ...
                for(i=0;i<certl;i++){
                    ...
                    $('#dynamic_fieldc').append('<section class="input-box" id="row'+i+'"><div class="row clear remove_other'+i+' "><div class="col-md-4"> <div class="form-group"> <label class="control-label">Name of the Professional Body:<span class="error-star" style="color:red;">*</span></label> <input class="form-control default" type="text" id="nopb" name="cert['+i+'][nopb]" value="'+Experience['cert'][i]['nopb']+'" autocomplete="off" readonly required value="" > </div> </div> <div class="col-md-3"> <div class="form-group"> <label class="control-label">Certificate issued by:<span class="error-star" style="color:red;">*</span></label> <input class="form-control default" type="text" id="certib" name="cert['+i+'][ib]" readonly required value="'+Experience['cert'][i]['certib']+'" autocomplete="off">  </div> </div> <div class="col-md-3"> <div class="form-group"> <label class="control-label">Certification Documents:<span class="error-star" style="color:red;">*</span></label> <label>'+Experience['cert'][i]['certfn']+'</label></div></div><div class="col-md-2"> <div class="form-group "> <label> <a type="button" class="btn btn-success " title="Download Documents" href="'+Experience['cert'][i]['certfp']+'/'+Experience['cert'][i]['certfn']+'" download=""><i class="fa fa-download" style="color:white!important"></i></a> <a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onclick="getproposaldocument('+doc+')"><input type="hidden" id="ocfn'+q+'" name="cert['+i+'][ocfn]" value="'+Experience['cert'][i]['certfn']+'"><input type="hidden" id="ougcfp'+q+'" name="cert['+i+'][ocfp]" value="'+Experience['cert'][i]['certfp']+'"><i class="fa fa-eye" style="color:white!important"></i></a></label></div></div></div><div class="row"> <div class="col-md-2"><div class="form-group"><input type="hidden" id="i'+q+'" name="f'+q+'" value="1"><input type="hidden" id="yn'+q+'" name="yn" value="1"></button></div></div><div class="col-md-3 dcertd" id="dcertd'+q+'" ><div class="form-group"><input class="form-control" type="file" id="certd'+q+'" name="cert['+i+'][certd]"  value="" autocomplete="off"> </div></div><div></div></div> </div> </div></section>'); 
