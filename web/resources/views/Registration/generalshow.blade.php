                                            ...
                                            <section class="section">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control "  required id="fname" name="fname" readonly value="{{$data['fname']}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Last Name:<span class="error-star" style="color:red;">*</span></label>
                                                                <input type="text" class="form-control "  required id="lname" name="lname" readonly value="{{$data['lname']}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Gender:<span class="error-star" style="color:red;">*</span></label>
                                                                    <div class="gender">
                                                                        <div>
                                                                            <input type="radio" class=""  required id="Male" name="gender" disabled value="Male" {{ ($data['gender'] === "Male") ? "checked" : "" }} ><span> Male</span>
                                                                        </div>
                                                                        <div>
                                                                            <input type="radio" class=""  required id="Female" name="gender" disabled value="Female" {{ ($data['gender'] === "Female") ? "checked" : "" }}><span> Female</span>
                                                                        </div>
                                                                        <div>
                                                                            <input type="radio" class=""  required id="Transgender" name="gender" disabled value="Transgender" {{ ($data['gender'] === "Transgender") ? "checked" : "" }}><span> Transgender</span>
                                                                        </div>
                                                                    </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <h style="color:black"><b>Address:</b></h>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="gender">
                                                                                <div>
                                                                                    <input type="radio" class=""  required id="al" name="lvc" disabled value="AgricultureLand" {{ ($data['lvc'] === "AgricultureLand") ? "checked" : "" }} ><span> Agriculture Land</span>
                                                                                </div>
                                                                                <div>
                                                                                    <input type="radio" class=""  required id="rel" name="lvc" disabled value="RealEstateLand" {{ ($data['lvc'] === "RealEstateLand") ? "checked" : "" }}><span> Real Estate Land</span>
                                                                                </div>
                                                                    
                                                                                <div>
                                                                                    <input type="radio" class=""  required id="pl" name="lvc" disabled value="PlantationLand" {{ ($data['lvc'] === "PlantationLand") ? "checked" : "" }}><span> Plantation Land</span>
                                                                                </div>
                                                                        </div>
                                                                    </div>
                                                            </div>     
                                                            <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="gender">
                                                                                <div>
                                                                                    <input type="radio" class=""  required id="val" name="role_c" disabled value="Valuer" {{ ($data['role_c'] === "Valuer") ? "checked" : "" }}><span> Valuer</span>
                                                                                </div>
                                                                                <div>
                                                                                    <input type="radio" class=""  required id="sur" name="role_c" disabled value="Surveyour" {{ ($data['role_c'] === "Surveyour") ? "checked" : "" }}><span> Surveyour</span>
                                                                                </div>
                                                                    
                                                                                <div>
                                                                                    <input type="radio" class=""  required id="asr" name="role_c" disabled value="Assessor" {{ ($data['role_c'] === "Assessor") ? "checked" : "" }}><span> Assessor</span>
                                                                                </div>
                                                                        </div>
                                                                    </div>
                                                            </div>             
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="row">
                                                            <div class="col-md-2">
                                                            <input type="text" class="form-control " maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required id="passport" name="passport"  value="{{$data['passport']}}">
                                                            </div>
                                                            <div class="col-md-5">
                                                            <div class="form-group" >
