                                                        ...
                                                        <div class="row">
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wrq" type="text" oninput="input(this)" id="cpvw" required name="wrq[cpvw]" autocomplete="off" >
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wrq" type="text" oninput="input(this)" id="teic" required name="wrq[teic]" autocomplete="off" >
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wrq" type="text" oninput="input(this)" id="acrr" required name="wrq[acrr]" autocomplete="off" >
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wrq" type="text" oninput="input(this)" id="imc" name="wrq[imc]" required autocomplete="off" >
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default wrq" type="text" id="laal" name="wrq[laal]" required autocomplete="off">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wre" type="date" oninput="input(this)" id="fde" name="wre[0][fde]" required  placeholder="DD-MM-YYYY" autocomplete="off" >
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default indent wre" type="date" oninput="input(this)" id="tde" name="wre[0][tde]" required autocomplete="off" >
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control default wre" type="text" id="aow" name="wre[0][aow]" required  autocomplete="off">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                                <div class="form-group">
                                                        ...
                                                        <input class="form-control default" type="text" id="nopb" name="cert[0][nopb]" required autocomplete="off" value="" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input class="form-control default" type="text" id="certib" name="cert[0][ib]" required value="" autocomplete="off">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input class="form-control " type="file" id="certd" name="cert[0][certd]" value="" required autocomplete="off">
                                                    </div>
