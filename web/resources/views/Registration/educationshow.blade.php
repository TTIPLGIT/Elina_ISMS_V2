 ...
 function(isConfirm){
   ...
   if (isConfirm){
    var button_id = bid; 
       ...
       button_id =  "#row"+button_id+"";alert(button_id);
      $(button_id).remove();  
      --i;
