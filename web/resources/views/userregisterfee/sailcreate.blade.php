...
<style>
    ...
    /* ============================================================
       MOBILE RESPONSIVE – same as previous userregisterfee page
       ============================================================ */
...
<div class="main-content" style="min-height:'60px'">
    ...
    <section class="section">
        ...
        <div class="section-body mt-1">
            ...
            <form action="{{route('userregisterfee/store_data')}}" method="POST" id="sub_mit">
                @csrf
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="payment_amount" name="payment_amount" value="2000" autocomplete="off">
                                            </div>
                                        </div>
                                        <br>
                                    ...
                                    <div class="form-notes">
                                        ...
                                        <textarea class="form-control form-note" type="textarea" id="payment_process_description" name="payment_process_description">Kindly Pay your SAIL Assessment Payment</textarea>
                                    </div>
...
<script>
    function save() {
        ...
        if (enrollment_child_num == '') {
            swal("Please Select Enrollment Number", "", "error");
            return false;
        }
