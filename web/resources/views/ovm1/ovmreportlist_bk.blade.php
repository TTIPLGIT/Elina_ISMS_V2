                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <form action method="POST" action="">
                            ...
                            @if($reportflag == 0)
                            @if(in_array($row['ovm_meeting_id'] , $completed) || $row['status'] == 'Completed')
                            <a class="btn btn-info" title="SAIL Guide" data-toggle="modal" data-target="#templates1" onclick="getproposaldocument1('{{$row['child_id']}}')" style="margin-inline:5px"><i class="fa fa-file-pdf-o" style="color:white!important"></i></a>
                            @else
