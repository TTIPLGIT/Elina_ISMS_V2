...
@endif
    ...
    <section class="section">
        ...
        <div class="section-body mt-1">
            ...
            @endif
            <!-- <a style="float:right; position:relative;background-color: #2196f3ab;margin: 0 15px 2px 0px;" class="btn" title="view Document" data-toggle="modal" data-target="#templates" onclick="getproposaldocument()"><i class="fa fa-arrow-down"></i>&nbsp; Final Report </a> -->
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <form action method="POST" action="">
                                                        ...
                                                        <!-- @php $ovmreport =  Crypt::Encrypt($ovmreport) @endphp -->

                                                        @if($row['status'] != 'Completed')
                                                        <a class="btn btn-labeled btn-warning" style="background: warning !important; border-color:warning !important; color:warning !important" title="Edit" href="{{ route('ovmcompletedisedit',['id' => $id , 'role' => $role]) }}">
                                                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-file-o"></i></span>Edit </a>
                                                        <a type="button" href="{{ route('feedbacksubmit',$id) }}" id="submitbutton" class="btn btn-labeled btn-succes" title="Submit" style="background: green !important; border-color:green !important; color:white !important">
                                                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-check"></i></span> Submit</a>
                                                        @else
                                                        <a class="btn btn-labeled btn-warning" style="background: warning !important; border-color:warning !important; color:warning !important" title="Edit" href="{{ route('ovmcompletedisedit',['id' => $id , 'role' => $role]) }}">
                                                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-file-o"></i></span>View </a>
                                                        @endif
