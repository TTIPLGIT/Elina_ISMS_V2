                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row is-coordinate">
                                ...
                                <input type="hidden" id="ovm_meeting_id" name="ovm_meeting_id" value="{{ $row['ovm_meeting_id']}}" readonly>
                                        ...
                                        <table class="table" id="myTable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><textarea class="form-control default" order="0" id="profession_of_the_parents" title="Parent’s info" name="profession_of_the_parents">{{ $row['profession_of_the_parents']}}</textarea></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><textarea class="form-control default" order="0" id="siblings" title="Family info" name="siblings">{{ $row['siblings']}}</textarea></td>
                                                </tr>
                                                <tr>
                                                    <td>Birth History</td>
                                                    <td> <textarea class="form-control default" order="0" id="birth_history" title="Birth History" name="birth_history">{{ $row['birth_history']}}</textarea></td>
                                                </tr>
                                                <tr>
                                                    <td>Developmental Milestones – Motor / Lang / Speech</td>
                                                    <td><textarea class="form-control default" order="0" id="developmental_milestones_motor_lang_speech" title="Developmental Milestones Motor Lang Speech" name="developmental_milestones_motor_lang_speech">{{ $row['developmental_milestones_motor_lang_speech']}}</textarea></td>
                                                </tr>
                                                <tr>
                                                    <td>Schools attended / School s/he currently in / Grade</td>
                                                    <td>
                                                        <textarea class="form-control default" order="0" id="schools_attended_school_currently_grade" title="Schools Attended School Currently Grade" name="schools_attended_school_currently_grade">{{ $row['schools_attended_school_currently_grade']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Previous interventions given / Current intervention </td>
                                                    <td>
                                                        <textarea class="form-control default" order="1" id="previous_interventions_given_current_intervention" title="Previous Interventions Given Current Intervention" name="previous_interventions_given_current_intervention">{{ $row['previous_interventions_given_current_intervention']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Any assessment done?</td>
                                                    <td>
                                                        <textarea class="form-control default" order="1" id="any_assessment_done" title="Any Assessment Done" name="any_assessment_done">{{ $row['any_assessment_done']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Food / Sleep pattern / Any medication?</td>
                                                    <td>
                                                        <textarea class="form-control default" order="1" id="food_sleep_pattern_any_medication" title="Food Sleep Pattern Any Medication" name="food_sleep_pattern_any_medication">{{ $row['food_sleep_pattern_any_medication']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Socialization / Emotional /communication/ Sensory </td>
                                                    <td>
                                                        <textarea class="form-control default" order="1" id="socialization_emotional_communication_sensory" title="Socialization Emotional Communication Sensory" name="socialization_emotional_communication_sensory">{{ $row['socialization_emotional_communication_sensory']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ADLs - General Routine</td>
                                                    <td>
                                                        <textarea class="form-control default" order="1" id="adls_general_routine" title="ADLs - General Routine" name="adls_general_routine">{{ $row['adls_general_routine']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Strength / Interests</td>
                                                    <td>
                                                        <textarea class="form-control default" order="2" id="strength_interests" title="Strength Interests" name="strength_interests">{{ $row['strength_interests']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Current challenges / concerns</td>
                                                    <td>
                                                        <textarea class="form-control default" order="2" id="current_challenges_concerns" title="Current challenges concerns" name="current_challenges_concerns">{{ $row['current_challenges_concerns']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Other information</td>
                                                    <td>
                                                        <textarea class="form-control default" order="2" id="other_information" title="Other information" name="other_information">{{ $row['other_information']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Academics
                                                    ...
                                                    <td>
                                                        <textarea class="form-control default" order="2" id="academics" title="Academics" name="academics">{{ $row['academics']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><textarea class="form-control default" order="2" id="introspection" title="Introspection" name="introspection">{{ $row['introspection']}}</textarea></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><textarea class="form-control default" order="3" id="expectation_from_school" title="Expectation from School" name="expectation_from_school">{{ $row['expectation_from_school']}}</textarea></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea class="form-control default" order="3" id="expectation_from_elina" title="Expectation from Elina" name="expectation_from_elina">{{ $row['expectation_from_elina']}}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Notes</td>
                                                    <td><textarea class="form-control default" order="3" id="notes" title="Notes" name="notes">{{ $row['notes']}}</textarea></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
...
<script type="text/javascript">
    $("#submit").click(function() {
        ...
        //     }
        // }
        // $("#submit").removeClass('disable-click');
    });
</script>
