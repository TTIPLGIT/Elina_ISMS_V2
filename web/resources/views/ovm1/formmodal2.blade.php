<div class="modal fade" id="templates1" tabindex="-1" aria-labelledby="templates1" aria-hidden="true">
  <div class="modal-dialog modal-xl" style="height:90% !important" >
    <div class="modal-content" style="height:90% !important">
      ...
      <div class="modal-body" id="template1">
      ...
      <button onclick="send_form()" class="btn btn-danger" data-dismiss="modal">Send</button>
