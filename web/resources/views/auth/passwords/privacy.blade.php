...
/* Custom Responsive Header Styling */
.header-row {
    background-color: #26268d !important; /* Theme blue color */
    padding: 15px 30px;
    display: flex;
    align-items: center;
...
.logo-img {
    height: 65px; /* Elegant height on desktop */
...
.title-text {
    ...
    font-size: 32px !important; /* Clean title size */
    margin: 0;
    line-height: 1.2;
}

/* Custom Responsive Content Card */
.content-container {
    padding: 40px 15px;
}
...
.content-card h2, .content-card h3, .content-card strong {
    color: #26268d;
}
...
@media (max-width: 767.98px) {
    .header-row {
        padding: 12px 15px;
        justify-content: flex-start; /* Keep them together to the left */
        min-height: 80px;
    }
    
    .logo-img {
        height: 45px; /* Reduced logo size on mobile */
    }
    
    .title-container {
        padding-left: 15px;
        text-align: left; /* Align title next to logo on mobile */
    }
    
    .title-text {
        font-size: 17px !important; /* Scale down title text nicely on mobile */
    }
    ...
    .content-card p {
        text-align: left; /* Left alignment is much better for mobile readability */
        margin-bottom: 1rem;
    }
}
...
@media (max-width: 480px) {
    .logo-img {
        height: 38px; /* Slightly smaller logo for very small phones */
    }
    
    .title-text {
        font-size: 14px !important; /* Scaled text size for compact portrait screens */
    }
}
</style>
    ...
    <body>
        <div class="header-row">
            <div class="logo-container">
                <a href="{{route('login')}}">
                    <img class="logo-img" src="{{asset('assets/images/elina-logo-2.png')}}" alt="ELINA Logo">
                </a>
            </div>
            <div class="title-container">
                <h2 class="title-text">ELINA-Intervention Service Management System</h2>
            </div>
        </div>  
