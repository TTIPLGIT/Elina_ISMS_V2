...
<head>
  ...
  <script type="text/javascript" src="{{ asset('plugins/bootbox/bootbox.all.js') }}"></script>
...
<body>
  <div class="header row">
    ...
    @endif
    <div class="col-md-1" style="align-items: center;"><a href="{{route('login')}}"><img class="" style="width: 200% !important;
    display: flex;
      ...
      <div class="col-sm-9 col-md-7 col-lg-4 mx-auto">
        <div class="card card-signin">
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('reset_password') }}" class="form-signin" id="resetform">
              @csrf
              ...
              <div class="form-label-group inner-addon right-addon" style="padding-bottom:20px ;">
                <i class="glyphicon fa fa-eye login_pass_icon" id="togglePassword"></i>
              ...
              <div class="centerclass">
                <a type="button" class="btn btn-info btn-login btn-block text-uppercase" onclick="validateForm()">Reset Password</a>
              </div>
...
<script>
  ...
  function validateForm() {
    ...
    if (password == '') {
      swal.fire("Plese Enter Password", "", "error");
      return false;
    }
    ...
    if (c_password == '') {
      swal.fire("Plese Enter Comfirm Password", "", "error");
      return false;
    }
    if (password != c_password) {
      swal.fire("Password and Comfirm Password should be same", "", "error");
      return false;
    }
    ...
    Swal.fire({
      ...
      text: "Please click 'Yes' to Change Password.",
      icon: "warning",
