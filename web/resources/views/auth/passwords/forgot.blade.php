...
<body>
  <div class="header row">
    ...
    <div class="col-md-1">
      <a href="{{route('login')}}">
        <img class="" style="width: 200px !important;display: flex;align-items: center !important;margin-top: 0.8rem;;
        padding: 0;" src="{{asset('assets/images/elina-logo-2.png')}}">
      </a>
    </div>
  ...
  <div class="container bgimg1 pt-5 ">
    ...
    align-items: center;
    margin: auto;" src="{{asset('assets/images/elina-logo-2.png')}}">
              <div class="form-label-group" style="padding:10px;">
                <!-- <i style="font-size:x-large" class="fa fa-user inputicon"></i> -->
                <input type="email" autocomplete="false" id="email" name="email" class="form-control" placeholder="Email">
              </div>
              ...
              <div class="centerclass mt-3">
                <button class="btn btn-lg btn-login btn-block text-uppercase" type="submit">Send Password Reset Link</button>
              </div>
              <div class="centerclass mt-3">
                <a href="{{ route('login') }}"
                  class="btn btn-lg btn-login btn-block text-uppercase">
                  Cancel
                </a>
              </div>
