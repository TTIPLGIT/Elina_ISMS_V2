...
<style>
  ...
  @media (max-width: 768px) {
    ...
    /* Enrollment ID – hidden initially (3rd column) */
    #align td:nth-of-type(3) {
      display: none !important;
    }

    /* Total Amount – hidden initially (4th column) */
    ...
    /* Expanded fields */
    #align tr.expanded-row td:nth-of-type(3) { /* Enrollment ID */
      display: block !important;
    ...
    #align tr.expanded-row td:nth-of-type(4) { /* Total Amount */
      display: block !important;
                  ...
                  <table class="table table-bordered" id="align">
                    ...
                    <tbody>
                      @foreach($rows as $key=>$row)
                        <tr>
                          <td data-label="SI.NO.">{{ ++$key }}</td>
                          <td data-label="Name">{{ $row['child_name'] }}</td>
                          <td data-label="Enrollment ID">{{ $row['enrollment_child_num'] }}</td>
                          <!-- <td>{{ $row['fee_type'] }}</td> -->
                          <td data-label="Total Amount">{{ $row['final_amount'] }}</td>
                          <td data-label="Action" class="text-center">
                            <a class="btn btn-danger btn-sm" href="{{ route('paymentmaster.customized.getdata', \Crypt::encrypt($row['id'])) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
