...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body mt-1">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('paymentmaster.customized.update') }}" method="POST" id="payment_store">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="child_enrollment" name="child_enrollment" required disabled>
                                                ...
                                                <option value="{{ $data['enrollment_id'] }}"
                                                    @if($rows['enrollment_id']==$data['enrollment_id']) selected @endif>
                                                    {{ $data['child_name'] }} ({{ $data['enrollment_child_num'] }})
                                                </option>
                                                @endif
                                                @endforeach
                                            </select>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        ...
                                        <button type="button" class="btn btn-success text-white" onclick="validateForm('Submitted')">Update</button>
...
<script>
    ...
    function handleServiceChange(selectElement) {
        ...
        // Auto-fill the rate and make it readonly with gray background
