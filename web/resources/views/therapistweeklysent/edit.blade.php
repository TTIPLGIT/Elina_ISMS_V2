                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <Select class="form-control" type="text" id="meeting_status" name="meeting_status" value="Sent" required autocomplete="off">
                                ...
                                <div class="row text-center">
                                    <div class="col-md-12">
                                        <button type="" onclick="send(event)" class="btn btn-labeled btn-succes" title="Submit" style="background:orange !important; border-color:green !important; color:white !important;height: 34px !important;">
                                        ...
                                        <a type=""href="{{route('TherapistInit')}}" class="btn btn-danger text-white">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
