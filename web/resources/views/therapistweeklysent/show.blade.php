...
<div class="main-content">
  ...
  <section class="section">
    ...
    <div class="section-body mt-1">
      <h5 class="text-center" style="color:darkblue">Therapist Initiative View</h5>
      <div class="row">
        <div class="col-12">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-2" style="margin: auto !important;">
                            ...
                            <input class="form-control" type="text" id="meeting_status" name="meeting_status" value="Sent" disabled="" placeholder="" required autocomplete="off">
                          </div>
