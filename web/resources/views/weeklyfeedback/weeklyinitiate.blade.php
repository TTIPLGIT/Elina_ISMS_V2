...
<div class="main-content" style="position:absolute !important; z-index: -2!important; ">
  ...
  <section class="section">
    ...
    <div class="section-body mt-1">
      <h5 class="text-center" style="color:darkblue">Weekly Feedback Initiate</h5>
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{route('weeklyfeedback.index')}}" method="GET" id="home_tracker" enctype="multipart/form-data">
                ...
                <div class="row is-coordinate">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" id="enrollment_child_num" name="enrollment_child_num" onchange="GetChilddetails()" required>
                        ...
                        <option value="{{ $row['enrollment_id'] }}">{{  $row['enrollment_id'] }}( {{$row['child_name']}} )</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" id="child_id" name="child_id" value="" placeholder="Child ID" autocomplete="off" readonly>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" id="child_name" name="child_name" value="" oninput="Childname(event)" maxlength="20" value="" placeholder="Enter Name" autocomplete="off" readonly>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type='date' class="form-control" id='meeting_startdate' name="meeting_startdate" title="Start Date" onchange="autodateupdate(this)" required>
                    </div>
                  </div>
      ...
      <div class="row text-center">
        <div class="col-md-12">
          ...
          <a type="button" class="btn btn-labeled back-btn" title="Back" href="{{ route('weeklyfeedback.index') }}" style="color:white !important">
...
title: "Are you want to Initiate the Weekly Feedback ?",
text: "Please click 'Yes' to Initiate the Weekly Feedback.",
icon: "warning",
...
if (result.value) {
  ...
  location.replace(`/weeklyfeedback?message2="${message}"`);
}
})
  ...
  function validateForm(a) {
    ...
    const message = "Valuer List Approved Successfully";
    location.replace(`/weeklyfeedback?message="${message}"`);
