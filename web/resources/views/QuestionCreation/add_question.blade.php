...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="section-body mt-0">
            ...
            <div class="col-md-12">
                <h4 style="text-align:center; color:darkblue"> Questionnaire Creation <a
                        style="float:right; position:relative;background-color: #2196f3ab;" class="btn"
                        href="{{ route('question_creation.index') }}"><i class="fa fa-arrow-left"
