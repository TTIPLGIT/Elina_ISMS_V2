                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row" style="margin-bottom: 5px;">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control" type="text" id="meeting_status" name="meeting_status" placeholder="New" value="Sent" disabled="" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">CC<span class="error-star" style="color:red;">*</span></label>
                                        <div class="col-sm-4">
                                            <input class="form-control" type="text" id="meeting_subject" name="meeting_subject" placeholder="Review Meeting"  value="sandy1999@gmail.com" title="Meeting Subject" required disabled="" readonly>
                                        </div>
                                    </div>
                                <div class="form-group row">
