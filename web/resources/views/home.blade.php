...
@section('content')
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-nowrap">
                                    ...
                                    <span class="text-secondary"
                                        style="padding: 0 0 0 14px;font-weight: 700;">{{$rows['users']['login_time']}}</span>
                                </li>
                ...
                <div class="col-md-5">
                    <div class="card cardheight headercolor">
                        <div class="card-header"><i class="fa fa-folder-open" id="fa-icon" aria-hidden="true"></i> Elina
                            Student Activity List</div>
                                ...
                                <div class="widget-content-wrapper text-white">
                                    <div class="widget-content-left">
                                        ...
                                        <div style="text-align: left;">
                                            ...
                                            <a class="dbox__title fontsweight" href="#elina_ovm" data-toggle="modal"
                                                data-target="#elina_ovm">View</a>
                                        </div>
                                    </div>
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-white numberfontsize"><span>
                                                {{$rows['chart2'][0]['ovm_count']}} </span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card mb-3 widget-content bg">
                                <div class="widget-content-wrapper text-white">
                                    ...
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-white numberfontsize"><span>
                                                {{$rows['chart2'][0]['sail_count']}}</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-3 widget-content bg">
                                <div class="widget-content-wrapper text-white">
                                    <div class="widget-content-left">
                                        ...
                                        <div style="text-align: left;">
                                            <a class="dbox__title fontsweight"
                                                href="{{url('report/assessmentreport')}}">View</a>
                                        </div>
                                    </div>
                                    <div class="widget-content-right">
                                        @foreach($rows['report'] as $rrow)
                                            @if($rrow['report_type'] == 7)
                                                <div class="widget-numbers text-white numberfontsize">
                                                    <span>{{$rrow['total']}}</span>
                                                </div>
                                            @endif
                                        @endforeach
                                    </div>
                                ...
                                <div class="widget-content-wrapper text-white">
                                    <div class="widget-content-left">
                                        ...
                                        <div style="text-align: left;">
                                            ...
                                            <a class="dbox__title fontsweight" href="#addModal" data-toggle="modal"
                                                data-target="#addModal">View</a>
                                        </div>
                                    </div>
                                    <div class="widget-content-right">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-xs-12">
                            ...
                            <div class="card">
                                <div class="card-header headercolor"><i class="fa fa-tasks" id="fa-icon"
                                        aria-hidden="true"></i> Elina Lead</div>
                                <div class="card-body">
                                    <ul class="list-group list-group-flush">
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <div class="float-left"><i class="fa fa-user" aria-hidden="true"></i><a
                                                    style="color:#6b747b;;font-weight: bold;" title="{{ __('View') }}"
                                                    href="#"> No of Elina leads</a> </div>
                                ...
                                <div class="card-footer">
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <a href="#addModal" data-toggle="modal" data-target="#addModal"
                                            style="font-weight: bold;"><span class="text-secondary"
                                                style="white-space: nowrap;">View All Leads <i class="fa fa-arrow-right"
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li
                                            ...
                                            <div class="float-right newcolor">
                                                {{$rows['blackboard'][0]['child_enrollement_count']}}
                                            </div>
                                        </li>

                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <div class="float-left" style="font-weight:bold;color:#6b747b;">OVM Meeting
                                            </div>
                                        ...
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <div class="float-left" style="font-weight:bold;color:#6b747b;">Completed
                                                Assessment</div>
                                        ...
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <div class="float-left" style="font-weight:bold;color:#6b747b;">CoMPASS Process
                                            </div>
                                            <div class="float-right newcolor">0</div>
                                        </li>
                                        ...
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <div class="float-left" style="font-weight:bold;color:#6b747b;">Renewal Process
                                            </div>
                                            <div class="float-right newcolor">0</div>
                                        </li>
                                        <li
                                            ...
                                            <div class="float-right newcolor cclr">{{$rows['blackboard'][0]['sla_crossed']}}
                                            </div>
                                        </li>
                                        <!-- <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center ">
                                        <a style=" font-weight: bold;color:#6b747b;;" href="#"
                                            title="{{ __('View') }}">Search By </a>
                                        <select class="form-control wp px-auto" name="elinalead" id="searchuserdata"
                                            onchange="selectfn(event)">
                                            <option value="">Select-Category</option>
                                            <option Value="child_name">Name</option>
                                            <option Value="enrollment_child_num">Enrollment Id</option>
                                            <option Value="child_contact_phone">Contact Number</option>
                                            <option Value="child_contact_email">Contact Email</option>
                                        </select>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center ">
                                        <a style=" font-weight: bold;color:#6b747b; " id="selectedcategory"
                                            class="text-capitalize" href="#" title="{{ __('View') }}">Category </a><input
                                            type="text" id="searchinput" class="form-control wp">
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap"
                                        style="height: 52px;">
                                        <h6></h6>
                                        <a class="btn btn-labeled btn-info text-white " type="button"
                                            onclick="elinaleadsearch()" title="{{ __('View') }}"><span class="text-white"><i
                                                    class="fa fa-search" aria-hidden="true"></i> Search</span></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="scrollable fixTableHead title-padding" id="scrolls">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table-custom-list card-body custom"
                                        ...
                                        <tbody style="background-color: white; " id="align1b">
                                            @foreach($rows['enrollment_details'] as $data)
                                                <tr>
                                                    ...
                                                    <!-- <td>{{$data['status']}}</td> -->
                                                    <!-- <td> <a onclick="overallStatus('{{$data['enrollment_id']}}')" title="Overall Status"><i class="fa fa-bars"></i></a></td> -->
                                                </tr>
                                            @endforeach
            ...
            <div class="row" id="row3">
                <div class="col-12 col-md-6">
                    <div class="card justify-content-md-center">
                        <div class="card-header headercolor justify-content-between"><i class="fa fa-history" id="fa-icon"
                                aria-hidden="true"> Access History</i>
                        ...
                        <div class="scrollable fixTableHead title-padding" id="scrolls">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered table-custom-list card-body"
                                    style="width:100% !important">
                                    <thead>
                                        <tr>
                                            <!-- <th scope="col">Audit ID</th> -->
    ...
    <script>
        ...
        function elinaleadsearch() {
            ...
            if (sb == '') {
                swal.fire("Please Select Search By Catagory", "", "error");
            }
                ...
                $.ajax({
                    ...
                    if (data != '[]') {
                        ...
                        if (data.length > 0) {
                            ...
                            optionsdata += "<tr><td colspan='6'>Search For Data</td></tr>";
                        }
                        var demonew = $('#align1b').html(optionsdata);
                    } else {
                        var ddd = "<tr><td colspan='6'>Search For Data</td></tr>";
        ...
        function selectfn(event) {
            ...
            const selectElement = document.getElementById('searchuserdata');
            const selectedOption = selectElement.options[selectElement.selectedIndex].innerHTML;
            selectedcategory.innerText = (!selectby) ? "category" : 'Child ' + selectedOption;
        }
    ...
    <script>
        function overallStatus(id) {
            // $(".loader").show();
            var enrollment_id = id; console.log(enrollment_id);
            $.ajax({
                ...
                if (data != '[]') {
                    ...
                    for (var i = 0; i < user_select.length; i++) {
                        ...
                        var action_date_time = user_select[i].action_date_time;
                        ddd += "<tr><td >" + (parseInt(i) + 1) + "</td><td>" + description + "</td><td> " + action_date_time + " </td></tr>";
                    }
...
@endsection enrollment_id = id;console.log(enrollment_id);
$.ajax({
url: '/user/status/view',
type: 'GET',
data: {
...
var user_select = data;
var ddd ;
for (var i = 0; i < user_select.length; i++) { var description=user_select[i].description; var
    action_date_time=user_select[i].action_date_time; ddd +="<tr><td >" + (parseInt(i) + 1) + "</td><td>" + description
    + "</td><td> " + action_date_time + " </td></tr>" ; } var demonew=$('#logTable').html(ddd); if (typeof
    initMobileAccordions==="function" ) initMobileAccordions(); } else { var stageoption=ddd.concat(optionsdata); } //
    $(".loader").hide(); $("#logModal").modal(); }) } </script>
    @include('modal.students_log')
    @include('modal.elina_dropped')
    @include('modal.elina_ovm')
    @include('modal.elina_leads')
