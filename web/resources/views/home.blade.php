                    ...
                    <div class="card">
                        ...
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <!-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe me-2 icon-inline">
                                        ...
                                        <i class="fa fa-briefcase" aria-hidden="true"></i> Designation</h6>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-nowrap">
                                ...
                                <span class="text-secondary" style="padding: 0 0 0 14px;font-weight: 700;">{{$rows['users']['login_time']}}</span>
                            </li>
                        ...
                        <div class="card mb-3 widget-content bg">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div style="text-align: left;">
                                        <a class="dbox__title fontsweight" href="{{url('report/assessmentreport')}}">View</a>
                                    </div>
                                </div>
                                <div class="widget-content-right">
                                    @foreach($rows['report'] as $rrow)
                                        @if($rrow['report_type'] == 7)
                                            <div class="widget-numbers text-white numberfontsize"><span>{{$rrow['total']}}</span></div>
                                        @endif
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6></h6>
                                    <a href="#addModal" data-toggle="modal" data-target="#addModal" style="font-weight: bold;"><span class="text-secondary" style="white-space: nowrap;">View All Leads <i class="fa fa-arrow-right" aria-hidden="true"></i></span></a>
                                </li>
                            </div>
                        </div>
                        <div class="card">
