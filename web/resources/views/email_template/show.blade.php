...
<div class="main-content">
    ...
    <div class="section-body mt-0">
        <h4> Email Template View </h4>

        @foreach($email as $data)
        <form action="{{ route('emailtemplate.update' , $data['id'] ) }}" id="email_create" method="post">
            {{ csrf_field() }}
            @method('put')
                ...
                <div class="row" style="margin-bottom: 15px;margin-top: 20px;">
                    ...
                    <div class="col-md-6">
                        <div class="form-group questionnaire">
                            ...
                            <input type="text" class="form-control" readonly name="email_screen" id="email_screen" value="{{$data['screen']}}">
                            <!-- <select class="form-control default" name="email_screen" id="email_screen">
                                <option value="">- Screen Name -</option>
                                <option value="Registration">Registration</option>
                                <option value="Enrollment">Enrollment</option>
                                <option value="OVM Initiate">OVM Meeting Invite</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group questionnaire">
                            ...
                            <input class="form-control" readonly type="text" id="email_subject" name="email_subject" value="{{$data['email_subject']}}" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-lg-12" style="margin: 20px 0px 0px 0px;">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="email_description" name="email_description">
                                {{$data['email_body']}}
                                </textarea>
                            </div>
                        </div>
