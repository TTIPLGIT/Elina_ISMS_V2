...
{{ Breadcrumbs::render('payuserfee.show',1) }}
    <div class="section-body mt-1">
      <h5 class="text-center" style="color:darkblue">Header Details</h5>
     
      <form action="{{route('payuserfee.store')}}" method="POST" id="newenrollement" enctype="multipart/form-data">
      @csrf
      <div class="row">
        <div class="col-12">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="enrollment_child_num" name="enrollment_child_num" value="EN/2022/12/025 (Vimal)" autocomplete="off" disabled>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="child_name" value="Vimal" name="child_name" autocomplete="off"disabled>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="initiated_to" name="initiated_to" value="kashwin331@gmail.com" autocomplete="off" disabled>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="payment_amount" name="payment_amount" value="20000" autocomplete="off" disabled>
                  </div>
                </div>
                <br>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="payment_status" name="payment_status" value="Paid" autocomplete="off" disabled>
                  </div>
                </div>
              ...
              <div class="form-notes">
                ...
                <textarea class="form-control form-note" type="textarea" id="payment_process_description" name="payment_process_description" value="Paid Rs 20000" disabled>Paid Rs 20000 for CoMPASS Registration Fee </textarea>
              </div>
