            ...
            <div class="row alert-row-top">
              ...
              <div class="col-md-6">
                <div class="card text-center">
                  <div class="card-header alert-head-background" style="justify-content: center;">{{ __('ISMS - Page Not Found') }}</div>
                  <div class="card-body">
                    <img src="{{ asset('images/wrong.png') }}" class="alert-image-size">
                    <p class="card-text alert-message-top">The page you are looking for doesn't exist or has been moved.</p>
