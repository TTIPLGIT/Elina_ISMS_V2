    ...
    <div id="app">
      <div class="main-wrapper main-wrapper-1">
          ...
          <ul class="navbar-nav navbar-right" style="width: 160px;">
            ...
            <li class="dropdown" style="width: 80%;">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item has-icon" href="{{Config::get('setting.base_url')}}profilepage"><i class="fa fa-user" style="color:red !important;"></i><b style="color:blue !important;">Profile</b></a>
                <a class="dropdown-item has-icon" href="{{Config::get('setting.base_url')}}FAQ_main"><i class="fa fa-question-circle" style="color:red !important;"></i><b style="color:blue !important;">FAQ</b></a>
                <a href="{{Config::get('setting.base_url')}}logout" class="dropdown-item has-icon" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                  <i class="fa fa-sign-out" style="color:red !important;"></i><b style="color:blue !important;">Logout</b></a>
                <form id="logout-form" action="{{Config::get('setting.base_url')}}logout" method="POST" style="display: none;">
        ...
        <div class="main-sidebar sidebar-style-2" style=" background-color: rgb(0, 34, 102) !important;">
          ...
          <input type="hidden" name="testing_id" id="testing_id" value="{{Config::get('setting.base_url')}}">
        </div>
      </div>
    </div>
