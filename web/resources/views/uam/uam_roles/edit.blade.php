...
<div class="main-content">
   ...
   {{ Breadcrumbs::render('uam_modules_screens.edit',$rows[0]['role_id']) }}

      <div class="section-body mt-1">
         <!-- HEADING CENTERED -->
         <h5 class="text-center" style="color:darkblue;">Role Edit</h5>
         <div class="row">
            ...
            <div class="col-12">
               ...
               <div class="card">
                  <div class="card-body">
                  <form class="form-horizontal" method="post" name="uam_roles" id="uam_roles" onsubmit="return validateForm()" action="{{ route('uam_roles.update',\Crypt::encrypt($rows[0]['role_id'])) }}">
