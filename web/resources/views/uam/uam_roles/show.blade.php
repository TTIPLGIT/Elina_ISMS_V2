<style type="text/css">
  ...
  /* Original pointer-events style kept */
  label {
    pointer-events: none;
  }
</style>
...
<div class="main-content">
   ...
   {{ Breadcrumbs::render('uam_modules_screens.show',$rows[0]['role_id']) }}

      <div class="section-body mt-1">
         <!-- HEADING CENTERED -->
         <h5 class="text-center" style="color:darkblue;">Role Show</h5>
         <div class="row">
                                                                  ...
                                                                  <ul>
                                                                     ...
                                                                     <li> <label><input id="node-{{$screen_data_value_four['module_id'] }}-{{$screen_data_value_four['screen_id'] }}" data-id="{{$screen_data_value_four['module_id'] }}:{{$screen_data_value_four['screen_id'] }}" type="checkbox"> {{$screen_data_value_four['screen_name'] }} </label>
                                                                        <ul style="display:inline-flex;float:right">
                                                                           ...
                                                                           <li> <label><input class="hummingbird-end-node" data-id="node1-{{$permissions_data_value['screen_permission_id'] }}-{{$screen_data_value_four['module_id'] }}-{{$screen_data_value_four['screen_id']}}" id="{{$screen_data_value_four['module_id'] }}:{{$permissions_data_value['screen_id'] }}" type="checkbox"> {{$permissions_data_value['permission'] }} </label></li>
                                                            ...
                                                            <ul>
                                                               ...
                                                               <li> <label><input id="node-{{$screen_data_value_three['module_id'] }}-{{$screen_data_value_three['screen_id'] }}" data-id="{{$screen_data_value_three['module_id'] }}:{{$screen_data_value_three['screen_id'] }}" type="checkbox"> {{$screen_data_value_three['screen_name'] }} </label>
                                                                  <ul style="display:inline-flex;float:right">
                                                                     ...
                                                                     <li> <label><input class="hummingbird-end-node" data-id="node1-{{$permissions_data_value['screen_permission_id'] }}-{{$screen_data_value_three['module_id'] }}-{{$screen_data_value_three['screen_id']}}" id="{{$screen_data_value_three['module_id'] }}:{{$permissions_data_value['screen_id'] }}" type="checkbox"> {{$permissions_data_value['permission'] }} </label></li>
                                                      ...
                                                      <ul>
                                                         ...
                                                         <li> <label><input id="node-{{$screen_data_value_two['module_id'] }}-{{$screen_data_value_two['screen_id'] }}" data-id="{{$screen_data_value_two['module_id'] }}:{{$screen_data_value_two['screen_id'] }}" type="checkbox"> {{$screen_data_value_two['screen_name'] }} </label>
                                                            <ul style="display:inline-flex;float:right">
                                                               ...
                                                               <li> <label><input class="hummingbird-end-node" data-id="node1-{{$permissions_data_value['screen_permission_id'] }}-{{$screen_data_value_two['module_id'] }}-{{$screen_data_value_two['screen_id']}}" id="{{$screen_data_value_two['module_id'] }}:{{$permissions_data_value['screen_id'] }}" type="checkbox"> {{$permissions_data_value['permission'] }} </label></li>
      ...
      <form id="override_options_form" method="POST" action="" style="display: none">
        <div class="form-group">
          <div class="checkbox text-left">
            <label><input id="checkbox_doubles" name="checkbox_doubles" value="1" type="checkbox" checked>Enable checking for n-tupel (doubles, triplets, ...) nodes</label>          </div>
            <div class="checkbox text-left">
              <label><input id="checkbox_get_items" name="checkbox_get_items" type="checkbox" value="1" checked>Getting number of checked nodes on the fly</label>          </div>
