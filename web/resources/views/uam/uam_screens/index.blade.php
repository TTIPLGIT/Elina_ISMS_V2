  ...
  <section class="section">
    ...
    <div class="section-body mt-2">
      ...
      @if(strpos($screen_permission['permissions'], 'Create') !== false)
        <a type="button" style="font-size:15px; margin: 0 0px 5px 15px;" class="btn btn-success btn-lg" href="{{ route('uam_screens.create') }}">Add Screens</a>
       @endif 
        <style>
          .section {
            margin-top: 20px;
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            @if(strpos($screen_permission['permissions'], 'Show') !== false)
                                <a class="btn btn-info" href="{{ route('uam_screens.show', \Crypt::encrypt($row['screen_id'])) }}">{{ __('Show') }}<span></span></a>
                               @endif

                               @if(strpos($screen_permission['permissions'], 'Edit') !== false)
                                <a class="btn btn-warning" href="{{ route('uam_screens.edit', \Crypt::encrypt($row['screen_id'])) }}">{{ __('Edit') }}<span></span></a>
                                @endif
