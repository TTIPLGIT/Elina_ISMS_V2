...
<style>
  ...
  @media (max-width: 768px) {
    ...
    /* Module Name – primary field (2nd column) */
    ...
    /* Screen Name – hidden initially (3rd column) */
    #align td:nth-of-type(3) {
      display: none !important;
    }

    /* Action – hidden initially (4th column) */
    ...
    /* Expanded fields */
    #align tr.expanded-row td:nth-of-type(3) { /* Screen Name */
      display: block !important;
    ...
    #align tr.expanded-row td:nth-of-type(4) { /* Action */
      display: flex !important;
    ...
    #align tr.expanded-row td:nth-of-type(4) form {
    ...
    #align tr.expanded-row td:nth-of-type(4) .btn {
      font-size: 11px !important;
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-lg-12 text-center">
                  <!-- Optional heading – left empty as per original -->
                </div>
              </div>
                    ...
                    <tbody>
                      @foreach($rows as $key=>$row)
                        <tr>
                          ...
                          <td data-label="Screen Name">{{ $row['screen_names'] }}</td>
                          <td data-label="Action" class="text-center">
                            <form action="{{ route('uam_modules_screens.destroy', \Crypt::encrypt($row['module_screen_id'])) }}" method="POST">
                              @if(strpos($screen_permission['permissions'], 'Show') !== false)
                                <a class="btn btn-info btn-sm" href="{{ route('uam_modules_screens.show', \Crypt::encrypt($row['module_id'])) }}">Show</a>
                              @endif
                              @csrf
                              @method('DELETE')
