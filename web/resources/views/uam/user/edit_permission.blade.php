...
<style>
  ...
  @media (max-width: 768px) {
    ...
    #treeview_container ul ul ul ul {
      display: block !important;
    ...
    #treeview_container ul ul ul ul li {
...
<div class="main-content">
   ...
   <section class="section">
      <div class="section-body mt-1">
         <h5 class="text-center" style="color:darkblue;">User Role Screen Mapping Edit</h5>
         <div class="row">
            <div class="col-12">
               <div class="card">
                  <div class="card-body">
                           ...
                           <div class="col-md-12">
                              ...
                              <div id="treeview_container" class="hummingbird-treeview h-scroll-large">
                                 <ul id="treeview" class="hummingbird-base">
                                    ...
                                    @if(!in_array($module_data_value['module_id'], $module_array) && $module_data_value['parent_module_id']==1)
                                    ...
                                    @else
                                    <!-- M1 -->
                                    @foreach($sub_module as $key => $sub_module_value)
                                    @if($sub_module_value['module_id'] == $module_data_value['parent_module_id'])
                                    @php $msID = $module_data_value['parent_module_id'];if(in_array($msID, $a)){$msID = 0;}array_push($a, $msID); @endphp
                                    @if($msID != 0)
                                    <li><i class="fa fa-plus"></i> <label> <input id="node--{{$sub_module_value['module_id'] }}" data-id="{{$sub_module_value['module_id'] }}" module="{{$sub_module_value['module_id'] }}" type="checkbox"> {{$sub_module_value['module_name'] }}</label>
                                       <ul>

                                          <!-- M2 -->
                                          @foreach ($module_data as $key => $module_data_value_two)
                                          @if($module_data_value_two['parent_module_id'] == $sub_module_value['module_id'])
                                          <li><i class="fa fa-plus"></i> <label> <input id="node--{{$module_data_value_two['module_id'] }}" data-id="{{$module_data_value_two['module_id'] }}" module="{{$module_data_value_two['module_id'] }}" type="checkbox"> {{$module_data_value_two['module_name'] }}</label>
                                             <ul>
                                          ...
                                          @if($screens_data !="")
                                          @foreach ($screens_data as $key => $screen_data_value)
                                          @if($sub_module_value['module_id'] == $screen_data_value['module_id'])
                                          <li> <label><input id="node-{{$screen_data_value['module_id'] }}-{{$screen_data_value['screen_id'] }}" data-id="{{$screen_data_value['module_id'] }}:{{$screen_data_value['screen_id'] }}" type="checkbox"> {{$screen_data_value['screen_name'] }} </label>
                                             <ul style="display:inline-flex;float:right">
                                                @if($permissions_data !="")
                                                @foreach ($permissions_data as $key => $permissions_data_value)
