                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            {{-- @if(strpos($screen_permission['permissions'], 'Show') !== false)
                                <a class="btn btn-info" href="{{ route('uam_modules.show', \Crypt::encrypt($row['module_id'])) }}">{{ __('Show') }}<span></span></a>
                               @endif --}}



                                @if(strpos($screen_permission['permissions'], 'Edit') !== false)
                                <a class="btn btn-warning" href="{{ route('uam_modules.edit', \Crypt::encrypt($row['module_id'])) }}">{{ __('Edit') }}<span></span></a>
                               @endif
