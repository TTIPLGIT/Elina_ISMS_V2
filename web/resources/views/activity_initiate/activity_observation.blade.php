...
@section('content')
  ...
  <div class="main-content" style="min-height:'60px'">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="enrollment_id" name="enrollment_id"
                  value="{{ $rows['enrollment_child_num'] }}" disabled autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="child_name" name="child_name" autocomplete="off"
                  value="{{ $rows['child_name'] }}" readonly>
              </div>
            </div>
          </div>
          <div class="text-center">
            <a href="#addModal2" data-toggle="modal" data-target="#addModal2" data-toggle="modal" title="Add to F2F"
              class="btn btn-labeled btn-success" data-target="#templates" onclick="clearAddModal()">
              <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-plus"></i></span> Add
              Activity</a>
            <a type="button" class="btn btn-labeled back-btn" title="Back" href="{{route('activity_initiate.index')}}"
    ...
    <div class="modal fade modalreset" id="addModal2">
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <form action="{{route('activity_f2f.store')}}" method="POST" id="formmeeting" enctype="multipart/form-data"
            class="reset">
            @csrf
                ...
                <div class="row" style="margin-bottom: 15px;margin-top: 20px;">
                  <div class="col-md-4" id="question_field">
                    <div class="form-group questionnaire">
                      ...
                      <select class="form-control default activity_set selectActivitySet" name="activity_set"
                        id="activity_set">
                  ...
                  <div class="col-md-7 des_ption" style="display:none;">
                    <div class="form-group questionnaire">
                      ...
                      <select class="form-control default description selectDescription" name="description"
                        id="description">
                  ...
                  <div class="col-md-3 materials_list" style="display:none;">
                    <div class="form-group">
                      ...
                      <select data-placeholder="Select Materials" multiple
                        class="chosen-select materials materialsRequiredSaved" name="materials[]"
                  ...
                  <div class="col-md-4">
                    <div class="form-group questionnaire">
                      ...
                      <textarea class="form-control default tx_to_observe" name="to_observe" id="to_observe"
                  ...
                  <div class="col-md-4">
                    <div class="form-group questionnaire">
                      ...
                      <textarea class="form-control default tx_ask_parent" name="ask_parent" id="ask_parent"
                        autocomplete="off"></textarea>
                    </div>
                  </div>
                  <div class="col-md-4" id="">
                    <div class="form-group questionnaire">
                      ...
                      <textarea class="form-control default tx_Observation" name="Observation" id="Observation"
                        autocomplete="off"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12" style="display:flex;justify-content: center;gap:5px">
                    <a type="button" onclick="saveQuestion1('Submit')" id="submitbtn" class="btn btn-success"
                      title="Add Activity" style="color:white !important">Submit</a>
                    <a type="button" onclick="saveQuestion1('Save')" id="savebtn" class="btn btn-success"
                      title="Save Activity" style="color:white !important">Save</a>
                    <a type="button" class="btn back-btn" title="Close" onclick="saveQuestion('Close')"
                      style="color:white !important">Close</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="modal fade" id="editModal2">
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <form action="{{route('activity_f2f.update')}}" id="edit_Question" method="POST" enctype="multipart/form-data"
            class="reset">
            @csrf
              ...
              <div class="card question" id="next-section">
                <div class="row" style="margin-bottom: 15px;margin-top: 20px;">
                  <div class="col-md-4" id="question_field">
                    <div class="form-group questionnaire">
                      <label class="control-label required">Activity Set</label>
                      <input class="form-control" type="text" id="activity_set_edit" name="activity_set" value=""
                  ...
                  <div class="col-md-7 des_ption">
                    <div class="form-group questionnaire">
                      <label class="control-label required">Activity Description</label>
                      <input class="form-control" type="text" id="description_id_edit" name="description_id" value=""
                        autocomplete="off" readonly>
                  ...
                  <div class="col-md-7">
                    <div class="form-group questionnaire">
                      <label class="control-label required">Materials Required</label>
                      <input class="form-control" type="text" id="materials_edit" name="materials_edit" value=""
                        autocomplete="off" readonly>
                  ...
                  <div class="col-md-4">
                    <div class="form-group questionnaire">
                      <label class="control-label required">To Observe</label>
                      <textarea class="form-control default" name="to_observe_edit" id="to_observe_edit"
                        autocomplete="off" value="" readonly></textarea>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group questionnaire">
                      <label class="control-label">To Ask Parents</label>
                      <textarea class="form-control default" name="ask_parent_edit" id="ask_parent_edit"
                  ...
                  <div class="col-md-12" style="display:flex;justify-content: center;gap:5px;">
                    <a type="button" onclick="saveQuestion('Update')" id="submitbtn" class="btn btn-success"
                      title="Update F2F Observation" style="color:white !important">Update</a>
                    <a type="button" class="btn back-btn" title="Close" onclick="saveQuestion('Close1')"
                      style="color:white !important">Close</a>
                  </div>
                </div>
              </div>
              ...
              <div class="card question" id="next-section">
                <div class="row" style="margin-bottom: 15px;margin-top: 20px;">
                  <div class="col-md-4" id="question_field">
                    <div class="form-group questionnaire">
                      <label class="control-label required">Activity Set</label>
                      <input class="form-control" type="text" id="activity_set_show" name="activity_set" value=""
                        autocomplete="off" readonly>
                  ...
                  <div class="col-md-7 des_ption">
                    <div class="form-group questionnaire">
                      <label class="control-label required">Activity Description</label>
                      <input class="form-control" type="text" id="description_id_show" name="description_id" value=""
                        autocomplete="off" readonly>
                  ...
                  <div class="col-md-7 materials_list">
                    <div class="form-group questionnaire">
                      <label class="control-label required">Materials Required</label>
                      <input class="form-control" type="text" id="materials_show" name="materials_show" value=""
                        autocomplete="off" readonly>
                  ...
                  <div class="col-md-4">
                    <div class="form-group questionnaire">
                      <label class="control-label required">To Observe</label>
                      <textarea class="form-control default" name="to_observe_show" id="to_observe_show"
                        autocomplete="off" value="" readonly></textarea>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group questionnaire">
                      <label class="control-label">To Ask Parents</label>
                      <textarea class="form-control default" name="ask_parent_show" id="ask_parent_show"
                        autocomplete="off" readonly></textarea>
                    </div>
                  </div>
                  <div class="col-md-4" id="">
                    <div class="form-group questionnaire">
                      <label class="control-label">Observation</label>
                      <textarea class="form-control default" name="Observation_show" id="Observation_show"
                        autocomplete="off" readonly></textarea>
                    </div>
                  </div>

                  <div class="col-md-12" style="display:flex;justify-content: center;">
                    <a type="button" class="btn btn-labeled back-btn" title="Close" data-dismiss="modal"
                      style="color:white !important">Close</a>
                  </div>
                </div>
              </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function () {
        ...
        $(".activity_set").change(function () {
          // Clear textareas and materials first
          $('.tx_to_observe').val("");
          $('.tx_ask_parent').val("");
          $('.tx_Observation').val("");
          $('.materials').val(null).trigger('change');
          $('.materials').html('<option value="">Select Materials</option>');
                  ...
                  if (f2fObs != null) {
                    ...
                    $('.materialsRequiredSaved').each(function () {
                      ...
                      materialsArray.forEach(function (material) {
                        if (material.trim() !== "" && $select.find("option[value='" + material + "']").length === 0) {
                          var newOption = new Option(material, material, true, true);
