                            ...
                            <table class="table table-bordered card-body" id="recommendation_table">
                                ...
                                <tbody id="tablebody">
                                    ...
                                    <tr class="recommendation_row">
                                        <td rowspan="1" id="recommendation{{$loop->iteration}}">
                                            <textarea style="height: 50px !important;width: 100% !important;" oninput="checkCharCount(this)" name="recommendation_area[{{$data['id']}}]">{{$data['recommendation']}}</textarea>
                                        </td>
                                        <td style="align-items: center;">
                                            <select class="form-control default" name="focus_area[{{$data['id']}}][]" id="focus_area{{$loop->iteration}}" onchange="focus_area('{{$loop->iteration}}')">
                                            ...
                                            <input class="form-control default" type="text" name="focus_area_other[{{$data['id']}}][]" id="otherInputfocus_area{{$loop->iteration}}" style="display: none;">
                                        </td>
                                        <td>
                                            <select class="form-control default" name="referral_users[{{$data['id']}}][]" id="referral_users{{$loop->iteration}}" onchange="checkOption(this)">
                                                <option value="">Select Referral</option>
                                            </select>
                                            <input class="form-control default" type="text" name="referral_users_other[{{$data['id']}}][]" id="otherInputreferral_users{{$loop->iteration}}" style="display: none;">
                                        </td>
                                        <td style="display: flex;align-items: center;">
                                            <input class="form-control default" type="text" id="frequency" name="frequency[{{$data['id']}}][]" autocomplete="off">
                                            <div class="row_div" order="{{$loop->iteration}}">
