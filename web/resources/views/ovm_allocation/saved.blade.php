...
<div class="main-content" style="position:absolute !important; z-index: -2!important; ">
    ...
    <section class="section">
        ...
        <div class="section-body mt-1">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{route('ovm_allocation.update' ,  $rows[0]['id'])}}" method="POST" id="ovmmeet1" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row is-coordinate">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control readonly" type="text" id="enrollment_child_num" name="enrollment_child_num" readonly value="{{ $rows[0]['enrollment_child_num']}} ( {{$rows[0]['child_name']}} )">
                                        </div>
                                    </div>
                                    <input type="hidden" id="user_id" name="user_id" value="{{$rows[0]['user_id']}}">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Child ID</label>
                                            <input class="form-control readonly" type="text" id="child_id" name="child_id" placeholder="Child ID" autocomplete="off" readonly value="{{$rows[0]['child_id']}}">
                                            <input type="hidden" id="enrollment_id" name="enrollment_id" autocomplete="off" readonly value="{{$rows[0]['enrollment_id']}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Child Name</label>
                                            <input class="form-control readonly" type="text" id="child_name" name="child_name" oninput="Childname(event)" maxlength="20" placeholder="Enter Name" value="{{$rows[0]['child_name']}}" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group ">
                                            ...
                                            <div style="display: flex;">
                                                <select class="form-control" id="is_coordinator1" name="is_coordinator1" readonly>
                                                    <option>Select-IS-Coordinator-1</option>
                                                    @foreach($iscoordinators as $key=>$row)
                                                    <option value="{{$row['id']}}" {{ $rows[0]['is_coordinator1'] == $row['id'] ? 'selected' : '' }}>{{ $row['name']}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex;">
                                                <select class="form-control" id="is_coordinator2" name="is_coordinator2" onchange="iscoordinatorfn(event)" readonly>
                                                    <option>Select-IS-Coordinator-2</option>
                                                    @foreach($iscoordinators as $key=>$row)
                                                    <option value="{{$row['id']}}" {{ $rows[0]['is_coordinator2'] == $row['id'] ? 'selected' : '' }}>{{ $row['name']}}</option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row is-coordinate">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" type="text" id="meeting_location" name="meeting_location" title="Meeting Location" maxlength="20" value="{{$rows[0]['meeting_location']}}" placeholder="Enter Location" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="inner-addon right-addon">
                                                ...
                                                <input type='text' value="{{$rows[0]['meeting_startdate']}}" class="form-control meeting_date" id='meeting_startdate' name="meeting_startdate" title="Meeting Start Date" onchange="autodateupdate(this)" placeholder="DD/MM/YYYY" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="content">
                                                <input class="form-control" value="{{$rows[0]['meeting_starttime']}}" type="time" id="meeting_starttime" name="meeting_starttime" title="Meeting Start Time" onchange="autoupdatedescription1()">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="inner-addon right-addon">
                                                <i class="glyphicon fas fa-calendar-alt"></i>
                                                <input type='text' value="{{$rows[0]['meeting_enddate']}}" class="form-control meeting_date" id="meeting_enddate" name="meeting_enddate" title="Meeting End Date" onchange="autodateupdate(this)" placeholder="DD/MM/YYYY" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="content">
                                                <input class="form-control" value="{{$rows[0]['meeting_endtime']}}" type="time" id="meeting_endtime" name="meeting_endtime" title="Meeting End Time" onchange="autoupdatedescription1()">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row is-coordinate">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Location<span class="error-star" style="color:red;">*</span></label>
                                        <div class="col-sm-4">
                                            <input class="form-control" type="text" id="meeting_location2" name="meeting_location2" title="Meeting Location" maxlength="20" value="{{$rows[0]['meeting_location2']}}" placeholder="Enter Location" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Start Date and Time<span class="error-star" style="color:red;">*</span></label>
                                        <div class="col-sm-4">
                                            <div class="inner-addon right-addon">
                                                <i class="glyphicon fas fa-calendar-alt"></i>
                                                <input type='text' value="{{$rows[0]['meeting_startdate2']}}" class="form-control meeting_date" id="meeting_startdate2" name="meeting_startdate2" title="Meeting Start Date" onchange="autodateupdate2(this)" placeholder="DD/MM/YYYY" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="content">
                                                <input class="form-control" value="{{$rows[0]['meeting_starttime2']}}" type="time" id="meeting_starttime2" name="meeting_starttime2" title="Meeting Start Time" onchange="autoupdatedescription2()">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="inner-addon right-addon">
                                                <i class="glyphicon fas fa-calendar-alt"></i>
                                                <input type='text' value="{{$rows[0]['meeting_enddate2']}}" class="form-control meeting_date" id="meeting_enddate2" name="meeting_enddate2" title="Meeting End Date" onchange="autodateupdate2(this)" placeholder="DD/MM/YYYY" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="content">
                                                <input class="form-control" value="{{$rows[0]['meeting_endtime2']}}" type="time" id="meeting_endtime2" name="meeting_endtime2" title="Meeting End Time" onchange="autoupdatedescription2()">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    function validateForm(a) {
        ...
        var is_coo1 = document.querySelector('#is_coordinator1').value;

        var is_coo2 = document.querySelector('#is_coordinator2').value;
