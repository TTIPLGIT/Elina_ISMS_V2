...
<div class="main-content" style="position:absolute !important; z-index: -2!important; ">
    ...
    <section class="section">
        ...
        <div class="section-body mt-1">
            <h5 class="text-center" style="color:darkblue">OVM Meeting Scheduling</h5>
                                ...
                                <div class="row is-coordinate">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            @php
                                            $en_id=$allocation_details[0]['enrollment_id'];
                                            $enrollment_child_num=DB::SELECT("SELECT enrollment_child_num from enrollment_details where enrollment_id=$en_id");
                                            @endphp
                                            <input class="form-control readonly" type="text" id="enrollment_child_num" name="enrollment_child_num" placeholder="Child ID" autocomplete="off" value="{{$enrollment_child_num[0]->enrollment_child_num}}" readonly>
                                        </div>
                                    </div>

                                    <input type="hidden" id="user_id" name="user_id" value="{{$allocation_details[0]['user_id']}}">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Child ID</label>
                                            <input class="form-control readonly" type="text" id="child_id" name="child_id" placeholder="Child ID" autocomplete="off" value="{{$allocation_details[0]['child_id']}}" readonly>
                                            <input type="hidden" id="enrollment_id" name="enrollment_id" autocomplete="off" value="{{$allocation_details[0]['enrollment_id']}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Child Name</label>
                                            <input class="form-control readonly" type="text" id="child_name" name="child_name" maxlength="20" placeholder="Enter Name" autocomplete="off" value="{{$allocation_details[0]['child_name']}}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group ">
                                            ...
                                            <div style="display: flex;">
                                                @php
                                                $isc_id=$allocation_details[0]['is_coordinator1'];
                                                $isc2_id=$allocation_details[0]['is_coordinator2'];
                                                $coord1=DB::SELECT("SELECT name from users where id=$isc_id");
                                                @endphp
                                                <input class="form-control readonly" type="text" id="is_coordinator1" name="is_coordinator1" maxlength="20" placeholder="Enter Name" autocomplete="off" value="{{$coord1[0]->name}}" readonly>

                                                <!-- <select class="form-control" id="is_coordinator1" name="is_coordinator1" onchange="iscoordinatorfn(event)">
                                            ...
                                            <input type="hidden" id="is_coordinator1id" name="is_coordinator1id" value="{{$allocation_details[0]['is_coordinator1']}}" data-attr='<?php echo json_encode($isc_id); ?>'>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex;">
                                                ...
                                                $isc2_id=$allocation_details[0]['is_coordinator2'];
                                                $coord2=DB::SELECT("SELECT name from users where id=$isc2_id");
                                                @endphp
                                                <input class="form-control readonly" type="text" id="is_coordinator2" name="is_coordinator2" maxlength="20" placeholder="Enter Name" autocomplete="off" value="{{$coord2[0]->name}}" readonly>

                                                <!-- <select class="form-control" id="is_coordinator2" name="is_coordinator2" onchange="iscoordinatorfn(event)">
                                            ...
                                            <input type="hidden" id="is_coordinator2id" name="is_coordinator2id" value="{{$allocation_details[0]['is_coordinator2']}}">
...
<script>
    ...
    function validateForm(a) {
        ...
        var date1 = new Date(meeting_startdate2);
        var MSdate1 = date1.toLocaleString("en-GB", {
            year: "numeric",
            month: "2-digit",
            day: "2-digit",
