...
<div class="main-content">
    ...
    <section class="section">
        ...
        <div class="section-body mt-1">
            <h5 class="text-center" style="color:darkblue">13+Questionnaire Allocation</h5>
            <div class="row">
                <div class="col-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="enrollment_id" name="enrollment_id" onchange="GetChilddetails()">
                                                ...
                                                <option value="EN/2023/12/070">EN/2023/12/070(Pavani)</option>
                                    ...
                                    <div class="form-group row" style="margin-bottom: 5px;display:none" id="chooseQuestionnaire">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="Category" name="Category" onchange="categorizedquestion()">
                                        ...
                                        <div class="col-md-6 versionlist" style="display:none !important;">
        ...
        <div class="row qtabs" style="display:none !important;">
            <div class="col-12">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="md-stepper-horizontal orange">
                                            ...
                                            <div class="md-step active done">
                                                ...
                                                <div class="md-step-content" style="display:none !important;">
                                                    <a class="gfg_tooltip">
                                                        <span class="gfg_text">
                                                            0/9
                                                        </span>
...
<script>
    function buttonAction(status) {
        ...
        var qname = $('#selectedQuestionnaire').val();
        if (qname == '' || qname == '0') {
