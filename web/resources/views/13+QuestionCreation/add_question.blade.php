...
<div class="main-content">
    {{ Breadcrumbs::render('thirteenquestion_creation.add_questions',['10']) }}
    <div class="section-body mt-0">

        <div class="col-md-12">
            <h4 style="text-align:center; color:darkblue"> 13+ Question Creation</h4>
        </div>
            ...
            <div class="row" style="margin-bottom: 15px;margin-top: 20px;">
                ...
                <div class="col-md-4">
                    <div class="form-group questionnaire">
                        ...
                        <div style="display: flex;">
                            <input class="form-control" type="text" value="37" style="width:40%" readonly />
                            <p style="width:10%"> Of </p>
                            <input class="form-control" type="number" id="no_of_ques" name="no_of_ques" value="37" style="width:50%" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-12">
                    <div class="form-group questionnaire">
                        ...
                        <textarea class="form-control" type="text" id="discription1" name="discription" placeholder="" autocomplete="off">Executive functioning - The way I process</textarea>
                    </div>
                </div>
                <div class="row text-center" style="margin-top: 10px;">
                    <input type="hidden" id="questionnaire_details_id" name="questionnaire_details_id" value="10">
                    <div class="col-md-12" style="">
                        <button type="button" class="btn btn-success" id="saveButton">Update</button>
                        <button type="button" class="btn" style="background-color: darkblue;color:white;" id="pulButton" onclick="myFunction1(1);">Publish</button>
        ...
        <form action="" id="add_Question" method="">
            ...
            <div class="card question" id="next-section">
                <div class="row" style="margin-bottom: 15px;margin-top: 20px;">
                    ...
                    <div class="col-md-6" style="display: none;" id="option">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-link" title="Delete" onclick="return myFunction('1');" class="btn btn-link"><i class="far fa-trash-alt"></i></a>
                                    </td>
...
@include('13+QuestionCreation.edit')
...
<script>
    $("#saveButton").click(function(event) {
        ...
        Swal.fire({
            ...
            type: "success", // Note: Use "success" instead of "Success"
        ...
        $.ajax({
            url: "{{ url('/thirteenquestion_creation/question_update') }}",
            type: "POST",
            data: {
                _token: '{{csrf_token()}}',
            ...
            success: function(data) {
                window.location.href = "/thirteenquestion_creation/add_questions/" + data;
            },
            error: function(data) {
                swal.fire({
                    title: "Error",
...
<script type="application/javascript">
    function myFunction1(id) {
        ...
        swal.fire({
            title: "Confirmation For Publish?",
            text: "Are you sure,you want to Publish this Questionnaire.",
            icon: "warning",
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                swal.fire("Published!", "Questionnaire Published successfully!", "success").then(() => location.reload());
            }
        });
...
<script>
    $(document).ready(function() {
        ...
        function updateSlNo() {
            $("#length5 tbody tr").each(function(index) {
