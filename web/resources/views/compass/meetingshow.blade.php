...
<div class="main-content">
  ...
  <section class="section">
    ...
    {{ Breadcrumbs::render('compass.show',1) }}
              ...
              <div class="card-body">
                ...
                <div class="form-group row" style="margin-bottom: 5px;">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input class="form-control" type="text" id="meeting_to" name="meeting_to" value="Kaviya@talentakeaways.com" disabled="" placeholder="" required autocomplete="off">
                ...
                <div class="form-group row" style="margin-bottom: 5px;">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input class="form-control" type="text" id="meeting_to" name="meeting_to" placeholder="Email Id" value="robert@talentakeaways.com" value="deena@talentakeaways.com" disabled="" required autocomplete="off">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input class="form-control" type="text" id="meeting_subject" name="meeting_subject" value="ORM Meeting" disabled="" placeholder="ORM Meeting" required autocomplete="off">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <label class="col-form-label">Description</label>
                      ...
                      <textarea class="form-control" id="description" name="meeting_description" value="ORM Meeting" readonly>kindly attend the meeting</textarea>
                    </div>
                  </div>
    ...
    <div class="row text-center">
      <div class="col-md-12">
        <a type="button" class="btn btn-labeled back-btn" title="Back" href="{{route('compassmeeting')}}" style="color:white !important">
