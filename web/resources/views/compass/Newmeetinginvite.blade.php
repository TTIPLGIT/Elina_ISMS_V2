...
<div class="main-content" style="position:absolute !important; z-index: -2!important; ">
  ...
  <section class="section">
    ...
    {{ Breadcrumbs::render('CompassNewmeetinginvite') }}
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input class="form-control" type="text" id="meeting_subject" name="meeting_subject" placeholder="ORM Meeting" title="Meeting Subject" required autocomplete="off">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  ...
                  <input type='text' class="form-control" id='meeting_startdate' name="meeting_startdate" title="Meeting Start Date" placeholder="dd-mm-yy"onchange="autodateupdate(this)" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type='text' class="form-control" id="meeting_enddate" name="meeting_enddate" title="Meeting End Date" placeholder="dd-mm-yy" onchange="autodateupdate(this)" required placeholder="MM/DD/YYYY">
                </div>
                <div class="col-sm-2">
