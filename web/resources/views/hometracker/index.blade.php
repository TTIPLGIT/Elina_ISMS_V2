...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.0.16/dist/sweetalert2.all.min.js"></script>
    ...
    <section class="section">
        ...
        {{ Breadcrumbs::render('hometracker.index') }}
            <div class="row">
                ...
                <a type="button"  href="{{route('hometrackerInit')}}"value="" class="btn btn-labeled btn-info" title="initiate" style="background: #044a95 !important; border-color:#a9ca !important; color:white !important;margin: 0 0 2px 15px;">
             <span class="btn-label" style="font-size:15px !important; padding:8px !important"><i class="fa fa-plus"></i></span><span style="font-size:15px !important; padding:8px !important">HomeTracker Initiation</span></a>
              @endif
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 text-center">
                                    <h4 style="color:darkblue;">Home Tracker List View</h4>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>         
                                                    <div class="progress" style="height: 25px;">
                                                        <div class="progress-bar" role="progressbar" aria-valuemax="100"style="font-weight: bolder;color:white; width:35%;background-color:red;">20/240</div>
                                                    </div>
                                                ...
                                                @endif
                                                @if($modules['user_role'] != 'Parent')
                                                <a class="btn"href="{{ route('viewcale') }}" style="margin-inline:5px;background-color:blue;"><i class="fa fa-calendar" style="color:white!important"></i></a>
                                                @endif
                                                    <a href="#addModal4" data-toggle="modal" data-target="#addModal4" class="btn btn-primary" title="View" data-toggle="modal" data-target="#templates" style="margin-inline:5px"><i class="fa fa-bars" style="color:white!important"></i></a>
...
window.onload = function () {
    ...
    if(message !=null)
    {
        ...
        window.history.pushState("object or string", "Title", "/hometracker/");
    }
