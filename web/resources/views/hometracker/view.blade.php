                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group ">
                                            ...
                                            <div style="display: flex;">
                                                <input class="form-control default" type="text" id="is_coordinator1" name="is_coordinator1" placeholder="Child ID" autocomplete="off" value="Robert" style="background-color: rgb(128 128 128 / 34%) !important;" readonly>
                          ...
                          <option value="131">Robert</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex;">
                                                <input class="form-control default" type="text" id="is_therapist" name="is_therapist" autocomplete="off" value="Malini" style="background-color: rgb(128 128 128 / 34%) !important;" readonly>
                          ...
                          <option value="134">Malini</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control default" type="text" id="date" name="date"  maxlength="20" value="hometracker(20-12)(20)" style="background-color: rgb(128 128 128 / 34%) !important;" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="main-content questionaire">
    ...
    <div class="row justify-content-center">
        ...
        <div class="tile-footer title-footer-button-alignment" style="padding: 10px;">
            ...
            <a class="btn btn-info" href="{{route('hometracker')}}">Back</a>
        </div>
    </div>
</div>
