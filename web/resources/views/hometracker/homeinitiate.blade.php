...
<div class="main-content" style="position:absolute !important; z-index: -2!important; ">
  ...
  <section class="section">
    ...
    {{ Breadcrumbs::render('hometrackerInit') }}
                  ...
                  <table class="table table-bordered" id="align">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Sent</td>               
                        <td>
                          <a class="btn btn-link" title="Show"  href="{{ route('hometracker.homesentshow',1) }}"><i class="fas fa-eye" style="color: blue !important"></i></a>
                          <!-- <a class="btn btn-link" title="Reschedule" href="{{ route('hometracker.homesentedit','2') }}"><i class="fas fa-pencil-alt" style="color:green"></i></a> -->
...
<script>
  function validateForm1(a) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        location.replace(`/hometrackerInit?message2="${message}"`);
      }
    })
  ...
  function validateForm(a) {
    ...
    const message = "Valuer List Approved Successfully";
    location.replace(`/hometrackerInit?message="${message}"`);
...
<script>
  ...
  let url = new URL(window.location.href)
      ...
      if(message!=null){
        Swal.fire({
                    title: "Success",
                    text: "HomeTracker Saved Successfully",
                    icon: "success",
                  });
...
<script>
  ...
  let url = new URL(window.location.href)
      ...
      if(message!=null){
        Swal.fire({
                    title: "Success",
                    text: "HomeTracker Initiated Successfully",
                    icon: "success",
                  });
      }
    };
