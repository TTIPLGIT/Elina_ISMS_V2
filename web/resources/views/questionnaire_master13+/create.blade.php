...
<div class="main-content">
  {{ Breadcrumbs::render('thirteenyrsquestionnaire_master.create') }}
  <div class="section-body mt-0">
  <h3 class="text-center" style="color:darkblue;">13+ Questionnaire Creation </h3>

    <form class="form-horizontal" name="questionnaire_form" id="questionnaire_form" method="" action="{{route('thirteenyrsquestionnaire_master.index')}}">
      @csrf
      ...
      <div class="row text-center" style="margin-top: 10px;">
        <div class="col-md-12">
          <a class="btn btn-success" onclick="validateForm('sent')" ><i class="fa fa-check"></i> Submit</a>&nbsp;
...
<script type="text/javascript">
  ...
  function validateForm(a) {
    ...
    var questionnaire_type = document.getElementById("questionnaire_type1").value;
    ...
    Swal.fire({
      ...
      title: "Are you Sure you want to Create the Questionnaire?",
      ...
      if (result.value) {
        const message = "Questionnaire Created Successfully";
        location.replace(`/thirteenyrsquestionnaire_master?message=${encodeURIComponent(message)}`);
      }
    })
