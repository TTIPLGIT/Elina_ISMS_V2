  ...
  <section class="section">
    <div class="section-body mt-2">
      ...
      <div class="row">
        ...
        <div class="col-12">
          <a type="button" href="{{route('questionnaireinitiate')}}" value="" class="btn btn-labeled btn-info" title="create" style="background: #044a95 !important; border-color:#a9ca !important; color:white !important;margin-top: 0.5rem;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <a class="btn btn-link" title="Delete" onclick="return myFunction(<?php echo $row['questionnaire_initiation_id']; ?>);" class="btn btn-link"><i class="far fa-trash-alt"></i></a>
                          @endif
                        </td>
                      </tr>
                      @endforeach
