                                        ...
                                        <table class="table table-bordered card-body">
                                            ...
                                            <tbody id="tablebody{{$page['page']}}">
                                                <tr class="firstrow" draggable="true" ondragstart="dragit(event)" ondragover="dragover(event)" ondragend="reOrder()">
                                                    <td>
                                                        <select class="form-control default activity{{$page['page']}}" id="activity{{$page['page']}}" name="activity[{{$page['assesment_skill_id']}}][]">
                                                    ...
                                                    <td style="display: flex;align-items: center;"><textarea style="height: 50px !important;" class="form-control default addProducttext{{$page['page']}}" name="evidence[{{$page['assesment_skill_id']}}][]"></textarea>
                                                        <a class="btn addProduct{{$page['page']}}" title="Add" order="{{$page['page']}}" id="addProduct{{$page['page']}}"><i class="fa fa-plus-circle" order="{{$page['page']}}" id="addProduct{{$page['page']}}"></i></a>
                                ...
                                <div class="table-responsive" id="table_a{{$page['page']}}">
                                    <table class="table table-bordered card-body">
                                        ...
                                        <tbody id="tablebody_a{{$page['page']}}">
                                            <tr class="firstrow">
                                                <td>
                                                    <select class="form-control default activity_a{{$page['page']}}" name="activity[{{$page['assesment_skill_id']}}][]">
                                                        <option value="">Select</option>
                                                        @foreach($activitys as $activity)
                                ...
                                <div class="table-responsive" id="table_b{{$sskill['skill_id']}}">
                                    <table class="table table-bordered card-body">
                                        ...
                                        <tbody id="tablebody_b{{$sskill['skill_id']}}">
                                            <tr class="firstrow">
                                                <td>
                                                    <select class="form-control default activity_c{{$sskill['skill_id']}}" name="activity[{{$page['assesment_skill_id']}}][]">
                                                        <option value="">Select</option>
                                                        @foreach($activitys as $activity)
                                                ...
                                                <td style="display: flex;align-items: center;">
                                                    ...
                                                    <a class="btn addProduct_b{{$sskill['skill_id']}}" title="Add" order="{{$page['page']}}" table="{{$sskill['skill_id']}}" id="addProduct_b{{$sskill['skill_id']}}"><i class="fa fa-plus-circle" order="{{$page['page']}}" table="{{$sskill['skill_id']}}" id="addProduct_b{{$sskill['skill_id']}}"></i></a></div>
...
<script>
    function addProduct(e) {
        ...
        var select = document.getElementsByClassName("activity_a" + order);console.log(select);
