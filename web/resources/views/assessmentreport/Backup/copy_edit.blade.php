...
<div class="main-content">
    ...
    {{ Breadcrumbs::render('assessmentreport.edit', $report[0]['enrollment_child_num'] ) }}
    ...
    <section class="section">
                                ...
                                <div id="Step{{$page['page']}}" class="card-body tabcontent paginationTab{{$page['page']}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="text-align: center;">
                                            <input type="checkbox" name="switch_radio" value="" class="switch_radio" @if($page['flag']=='1' ) checked @endif>
                                        </div>
                                    </div>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="required" width="40%">
                                                            Evidence
                                                            <input type="checkbox" style="float:right" name="switch[]" value="{{ $perskills['skill_id'] }}" class="check" onclick="handleCheckboxTable(this)" @if(in_array($perskills['skill_id'], explode(',', $report[0]['switch']))) checked @endif>
                                                        </th>
                                                    </tr>
                                                </thead>
                                            </table>
                        ...
                        <div class="col-12 scrollable fixTableHead title-padding" style="display: none;" id="page8">
                            <div class="table-responsive">
                                <table class="table table-bordered card-body" id="main">
                                    <thead>
                                        <tr>
                                            <th width="100%" style="border: 1px solid #040404 !important;color: #141414;background-color: white !important;">Seeking/Seeker
                                                <br>
                                    ...
                                    <tbody>
                                        <tr id="row">
                                            <td style="background: white;border: 1px solid #0e0e0e !important;vertical-align: initial !important;">
                                                <textarea style="width: 100%;height:150px;" class="tinymce-textarea" id="" name="rows2[1]">{{$page8[0]['sensory_profiling1']}}</textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <thead>
                                        <tr>
                                            <th width="100%" style="border: 1px solid #040404 !important;color: #141414;background-color: white !important;">Avoiding/Avoider
                                    ...
                                    <tbody>
                                        <tr id="row">
                                            <td style="background: white;border: 1px solid #0e0e0e !important;vertical-align: initial !important;">
                                                <textarea style="width: 100%;height:150px;" class="tinymce-textarea" id="" name="rows2[2]">{{$page8[0]['sensory_profiling2']}}</textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <thead>
                                        <tr>
                                            <th width="100%" style="border: 1px solid #040404 !important;color: #141414;background-color: white !important;">Sensitivity/Sensor
                                                <br>
                                    ...
                                    <tbody>
                                        <tr id="row">
                                            <td style="background: white;border: 1px solid #0e0e0e !important;vertical-align: initial !important;">
                                                <textarea style="width: 100%;height:150px;" class="tinymce-textarea" id="" name="rows2[3]">{{$page8[0]['sensory_profiling3']}}</textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <thead>
                                        <tr>
                                            <th width="100%" style="border: 1px solid #040404 !important;color: #141414;background-color: white !important;">Registration/Bystander
                                    ...
                                    <tbody>
                                        <tr id="row">
                                            <td style="background: white;border: 1px solid #0e0e0e !important;vertical-align: initial !important;">
                                                <textarea style="width: 100%;height:150px;" class="tinymce-textarea" id="" name="rows2[4]">{{$page8[0]['sensory_profiling4']}}</textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        <div class="picture-in-picture">
            ...
            <div id="pdfContainer" class="pdf-container" onclick="togglePictureInPicture('p2p')" title="Click to see the Report Preview">
                <iframe id="pdfViewerPIP" src="{{ asset('/assessment_report/' . $c_report . '/Assessment_Detail_Summary_Report.pdf')}}#page=2&toolbar=0&navpanes=0" scrolling="no"></iframe>
...
<div class="card conversation" id="reportPreview" style="display: none;">
    ...
    <div class="card-header conversation_header" onmousedown="startDragging(event)">
        <div class="chating-with">Report Preview</div>
        <div class="icons_chip">
            <!-- <button class="icon popout" title="Pop-out"><i class="far fa-square"></i></button> -->
...
<script>
    ...
    $(document).ready(function() {
        $('.conversation').draggable({
            cursor: "move",
            handle: ".conversation_header",
            drag: function(event, ui) {
                adjustCardAndPDFDimensions(ui.helper.width(), ui.helper.height());
            }
        });
        ...
        $("#reportPreview").resizable({
            ...
            resize: function(event, ui) {
                adjustCardAndPDFDimensions(ui.size.width, ui.size.height);
            }
        });
...
<script>
    document.querySelector('.exclamation-btn').addEventListener('click', function() {
        ...
        var enrollment_id = <?php echo json_encode($report[0]['enrollment_id']); ?>;
        ...
        $.ajax({
            ...
            success: function(data) {
                // Assuming 'data' is an array of observation records
                console.log(data);
...
<script>
    function save(a) {
        ...
        // Set the value of switch_radio_values to the hidden input field
...
<script>
    $(document).ready(function() {
        var enrollment_child_num = <?php echo json_encode($report[0]['enrollment_child_num']); ?>;
        // 
