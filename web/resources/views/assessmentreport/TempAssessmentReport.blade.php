...
<body style="font-family: 'Barlow Semi Condensed', sans-serif !important;">
  ...
  <!--  -->
  <form method="post" action="{{ route('assessment.report.SummaryReportSave' , \Crypt::encrypt($data['report_id'])) }}" id="submitForm">
    ...
    <input type="hidden" name="objData" id="objData" value="{{$data['objData']}}">
  </form>
</body>
<script>
  // $(".loader").show();
