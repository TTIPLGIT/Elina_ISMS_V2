      ...
      <div class="row">
        ...
        <div class="col-12">
          <a type="button" href="{{ route('assessmentreport.create') }}" value="Creat" class="btn btn-labeled btn-info" title="create" style="background: #044a95 !important; border-color:#a9ca !important; color:white !important;margin-top: 0.5rem;">
            <span class="btn-label" style="font-size:15px !important; padding:8px !important"><i class="fa fa-plus"></i></span><span style="font-size:15px !important; padding:8px !important">Assessment Report</span></a>
          <div class="card">
