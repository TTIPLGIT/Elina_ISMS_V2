...
<div class="main-content">
  ...
  <section class="section">
    ...
    <div class="section-body mt-1">
      <h5 class="text-center" style="color:darkblue"> F2F Session Closure</h5>
      <div class="row">
        <div class="col-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <label class='switch' data-bs-toggle='tooltip' data-bs-placement='top' title='Online / Offline'>
                      <input type='checkbox' class='toggle_status' onclick="functiontoggle()" id="meeting_mode" name='meeting_mode' value="1" @if($row['mode_of_meeting']=='1' ) checked @endif>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input class="form-control" type="text" id="meeting_location" name="meeting_location" onchange="changeLocation(this)" value="{{ $row['meeting_location']}}" placeholder="Enter Location" required autocomplete="off">
                  </div>
                </div>
                <div class="form-group row">
...
<script>
  ...
  var typedLocation = document.getElementById("meeting_location").value;
  ...
  var meetingDate = document.getElementById('meeting_startdate').value;
  var meetingTime = document.getElementById('meeting_starttime').value + ' to ' + document.getElementById('meeting_endtime').value;
  function autoupdatedescription1() {
    ...
    // console.log('r', mDate1, mTime1_s, mTime1_e);
