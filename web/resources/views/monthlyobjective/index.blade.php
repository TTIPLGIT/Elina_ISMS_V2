                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 text-center">
                                    <h4 style="color:darkblue;">Monthly Objective List View</h4>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>         
                                                    <div class="progress" style="height: 25px;">
                                                        <div class="progress-bar" role="progressbar" aria-valuemax="100"style="font-weight: bolder;color:white; width:35%;background-color:red;">4/8</div>
                                                    </div>
                                                ...
                                                <a class="btn" href="{{route('monthlyobjectiveviewcalendar')}}" style="margin-inline:5px;background-color:blue;"><i class="fa fa-calendar" style="color:white!important"></i></a>
                                                    <a href="#addModal3" data-toggle="modal" data-target="#addModal3" class="btn btn-primary" title="View" data-toggle="modal" data-target="#templates" style="margin-inline:5px"><i class="fa fa-bars" style="color:white!important"></i></a>
...
<script type="application/javascript">
    ...
    if(message !=null)
    {
        ...
        window.history.pushState("object or string", "Title", "/monthlyobjective/");
    }
