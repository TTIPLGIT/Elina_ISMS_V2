                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control default" type="text" id="name" name="name" title="Name" oninput="childName(event)" autocomplete="off" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control indent no-arrow" type="text" id="email_address" title="Email Address" minlength="10" maxlength="50" name="email_address" oninput="checkCont()" autocomplete="off" value="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="row justify-content inputcheck">
                                                    ...
                                                    <input class="form-control checks " type="checkbox" id="therapist{{$data['id']}}" name="area_of_specializtion[]" title="Areas of Specialization" value="{{$data['specialization']}}" required autocomplete="off">
                                                ...
                                                <div class="row offset-1 col-6 justify-content"> -->
                                                    <br/>
                                                    <input class="form-control checks" type="checkbox" id="other" name="area_of_specializtion[]" value="Other" title="Areas of Specialization" required autocomplete="off" onchange="inputchange(event)">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control " type="text" id="profession_charges_per_session" name="profession_charges_per_session" title="Professional charges per session" value="" oninput="completeCheck(this)">
            ...
            if (pageFormElements[i].value == "" || (pageFormElements[i].type == "radio" || pageFormElements[i].type == "checkbox")) {
                ...
                if ((pageFormElements[i].type == "text" && pageFormElements[i].style.display !== "none" && pageFormElements[i].parentElement.parentElement.parentElement.parentElement.style.display !== "none") || (pageFormElements[i].type == "date")) {
                    if (pageFormElements[i].value == "") {
                        ...
                        pageFormElements[i].value = removeURLs(pageFormElements[i].value);
                    }
