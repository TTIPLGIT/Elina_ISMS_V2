    ...
    function sub() {
        ...
        for (cindex = 1; cindex < divCount + 1; cindex++) {
            ...
            $('.pagination' + presentSten + '').each(function(i, el) {
                ...
                var Qrequired = $(el).attr('data-required'); //alert(required);
        ...
        for (let index = 0; index < DataFields.length; index++) {
            ...
            if (fieldTypeID == 4) {
                ...
                for (let index = 0; index < response.length; index++) {
                    ...
                    if (question_details_id == fieldID)
                        if (fieldValue == option_field_name) {
                            ...
                            radioButtonHtml += '<label><input style="margin-right: 10px;" class="pagination' + num + ' Qradio" type="radio" name="' + fieldName + '" id="' + fieldName + '" value="' + option_field_name + '" onclick="showInput(' + fieldName + ')" checked data-required="' + requiredQuestion + '"><i class="helper"></i>' + option_field_name;
                            radioButtonHtml += '</label></div>';
                        } else {
                            radioButtonHtml += '<div class="radio">';
                            radioButtonHtml += '<label><input style="margin-right: 10px;" class="pagination' + num + ' Qradio" type="radio" name="' + fieldName + '" id="' + fieldName + '" value="' + option_field_name + '" onclick="showInput(' + fieldName + ')" data-required="' + requiredQuestion + '" ><i class="helper"></i>' + option_field_name;
                            radioButtonHtml += '</label></div>';
                        }
                }
                // 
                if (otherOption == 1) {
                    ...
                    radioButtonHtml += '<input type="text" class="otherOption' + fieldName + '" '+(fieldID == '106' ? 'style="opacity: 1;width: 589px;margin: -2px 0px 0px 30px;' : 'style="opacity: 1;width: 589px;margin: -2px 0px 0px 80px;')+' name="' + fieldName + '">';
                    radioButtonHtml += '</label></div>';
                }
                // 
