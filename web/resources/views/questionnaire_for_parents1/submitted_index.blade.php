...
<div class="col-lg-12 text-center">
      <h4 style="color:darkblue;">Submitted Form</h4>
    </div>
                                                    ...
                                                    <div class="table-wrapper">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="align1">
                                                                ...
                                                                <tbody>
                                                                    @foreach($submitted_form as $data)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a class="btn btn-warning" style="cursor: pointer;" title="View" href="{{ route('questionnaire.submitted.form', \Crypt::encrypt($data['questionnaire_initiation_id'])) }}">{{ __('View') }}</a>
                                                                            @csrf
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
