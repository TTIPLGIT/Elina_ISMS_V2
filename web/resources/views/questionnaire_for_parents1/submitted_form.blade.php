...
<div class="main-content">
    ...
    @elseif($questionDetails[0]['questionnaire_type'] == 'SAIL')
        ...
        <div class="row is-coordinate">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" name="enrollment_id" readonly value="{{ $enrollmentDetails[0]['enrollment_child_num']}}" placeholder="Enrollment ID" required>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="child_id" readonly name="child_id" value="{{ $enrollmentDetails[0]['child_id']}}" disabled="" placeholder="OVM1 Meeting" required autocomplete="off">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="child_name" readonly name="child_name" value="{{ $enrollmentDetails[0]['child_name']}}" disabled="" placeholder="Enter Name" required autocomplete="off">
                </div>
            </div>
        </div>
    </div>
            ...
            if (fieldTypeID == 4) {
                ...
                for (let index = 0; index < response.length; index++) {
                    ...
                    if (question_details_id == fieldID) {
                        ...
                        if (fieldValue == option_field_name) {
                            ...
                            radioButtonHtml += '<label><input data-required="' + requiredQuestion + '" style="margin-right: 10px;" class="pagination' + num + ' Qradio" type="radio" name="' + fieldName + '" id="' + fieldName + '" value="' + option_field_name + '" onclick="showInput(' + fieldName + ')" checked disabled><i class="helper"></i>' + option_field_name;
                ...
                if (otherOption == 1) {
                    ...
                    if (setcheckOther == true) {
                        ...
                        radioButtonHtml += '<div class="radio">';
                        radioButtonHtml += '<label><input style="margin-right: 10px;" class="pagination' + num + ' Qradio" type="radio" name="' + fieldName + '" id="' + fieldName + '" value="Others" onclick="showInput(' + fieldName + ')" disabled><i class="helper" style="opacity: 0.1;"></i> '+(fieldID == '106' ? 'If yes, please mention the reason <br/>' : 'Others');
