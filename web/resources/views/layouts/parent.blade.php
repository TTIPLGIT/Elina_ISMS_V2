                    ...
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            ...
                            <div class="nav-profile-text d-flex flex-column">
                                ...
                                @if(!empty($modules['user_profile'][0]['parent_name']))
                                    <span class="text-secondary text-white">{{$modules['user_profile'][0]['role_name']}} - {{$modules['user_profile'][0]['parent_name']}}</span>
                                @else
