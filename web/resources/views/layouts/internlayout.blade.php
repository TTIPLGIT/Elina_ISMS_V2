    ...
    <div id="app">
        <nav class="navbar   navbar-light bg-white shadow-sm">
            ...
            <div style="width:100%">
                ...
                <div class="row ">
                    ...
                    <div class="vertical-center col-md-8  " style="font-size:xxx-large; font-family: 'Barlow Condensed', sans-serif;  color:#00607a !important;text-align:center !important "><b>INTERN APPLICATION FORM</b></div>
        ...
        <div style="border-color:#f5eeda !important; box-shadow: 0px 0px 0px !important;  width:100%; height:82vh; position:relative !important">
            <div class="row justify-content-center" style="margin-right: 0px !important; height:100%;   margin-left: 0px !important;">
                <div class="col-lg-4  background12" id="background12" style="padding: 0;"><img src="{{asset('images/internimage.jpg')}}" class="w-100">
                </div>
