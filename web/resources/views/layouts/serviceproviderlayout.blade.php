...
<head>
    ...
    <title>ISMS</title>
    <link rel='shortcut icon' type='image/x-icon' href="backgroundimg/cnooclogo.png" />
    <!-- CSRF Token -->
    ...
    <div id="app">
        <nav class="navbar   navbar-light bg-white shadow-sm">
            ...
            <div style="width:100%">
                ...
                <div class="row ">
                    ...
                    <div class=" col-lg-2 col-md-2"><img src="{{asset('images/mini-logo.png')}}" class="center" width="200px" height="709px" style="height: 75px;width: 85px;"></div>
                    </a>
                        <!-- <img src="{{asset('images/elina-logo-2.png')}}" class="logo " width="250px"> -->
                    </div>

                    <div class="vertical-center col-md-10 " style="font-size: 45px; font-family: 'Barlow Condensed', sans-serif;  color:#00607a !important;text-align:center !important "><b>ELINA SERVICE PROVIDER REGISTRATION</b></div>
        ...
        <div style="border-color:#f5eeda !important; box-shadow: 0px 0px 0px !important;  width:100%; height:82vh; position:relative !important">
            <div class="row justify-content-center" style="margin-right: 0px !important; height:100%;   margin-left: 0px !important;">
                <div class="col-lg-4  background12" id="background12" style=" background-image: url('images/SP_2.png') !important; background-size: cover;">

                </div>

                <div class="col-lg-8 col-md-12 col-sm-12" id="lrcontent" style="padding: 0;">
                    <main class="">
                        @yield('content')
                    </main>
                </div>
