...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/t4t5/sweetalert@v0.2.0/lib/sweet-alert.min.js"></script> -->
      ...
      <style>
            @media (min-width:319.96px) {
                body {
                    /* background-image: url('images/Elina Images/child.jpg'); */
...
input[type="date"]:valid:after {
    ...
    content: "Date of Registration" !important;
    color: #001d85 !important;
    font-weight: bolder !important;
...
.image{
     background-image: url('images/Elina Images/077.png');
     background-repeat: no-repeat;
     background-size:cover;
     
}
.image-1{
    background-image: url('images/Elina Images/loginbg1.png');
    background-repeat: no-repeat;
     background-size:cover;
}
.image-2{
...
/* passwordstrength */
    ...
    <body>
    <div id="app"><div class='loader' style="display: none;"></div>
    <div id="app">
