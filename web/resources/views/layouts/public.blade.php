...
<head>
    ...
    <style>
        ...
        .custom_radio input[type="radio"]:checked+label:before {
            -webkit-transition: all .3s ease;
            transition: all .3s ease;
            box-shadow: inset 0 0 0 0.2em white, inset 0 0 0 1em #004987;
        }
...
<body>
    <div id="app">
            ...
            <div style="width:100%">
                ...
                <div class="row ">
                    <div class="col-lg-2 col-md-2">
                        <a href="{{Config::get('setting.web_portal')}}">
                            <div class="logomobile col-lg-2 col-md-2"><img src="{{asset('images/mini-logo.png')}}" class="center" width="200px" height="709px" style="height: 75px;width: 85px;"></div>
                        </a>
                        <!-- <img src="{{asset('images/elina-logo-2.png')}}" class="logo " width="250px"> -->
                    </div>

                    <div class="vertical-center col-md-10"><b>ENROLLMENT FORM - PARENT</b></div>

                    <!-- <div class=" col-lg-2 col-md-2"><img src="{{asset('images/elina-logo-2.png')}}" class="logo center" width="200px" height="px"></div> -->
        ...
        <div style="border-color:#f5eeda !important; box-shadow: 0px 0px 0px !important;  width:100%; height:82vh; position:relative !important">
            <div class="row justify-content-center" style="margin-right: 0px !important; height:100%;   margin-left: 0px !important;">
                <div class="col-lg-4  background12" id="background12" style="padding: 0;"><img src="{{asset('images/Roadmap.png')}}" style="cursor: pointer;" class="w-100 h-100" data-toggle="modal" data-target="#exampleModalCenter">
                </div>

                <div class="col-lg-8 col-md-12 col-sm-12" id="lrcontent">
                    <main class="">
                        @yield('content')
                    </main>
                </div>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="z-index: 99999999 !important;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Roadmap of Elina Services</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" style="padding: 0 !important;">
                    <img src="{{asset('images/Roadmap.png')}}" class="w-100">
                </div>
