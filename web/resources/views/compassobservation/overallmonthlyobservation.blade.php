...
<div class="" style="position:absolute !important; z-index: -2!important; ">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="col-lg-12 text-center">
                            <h4 style="color:darkblue;">Observation View</h4>
                        </div>
                    </div>
                                ...
                                <div class="row is-coordinate">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="year" class="form-control" placeholder="YYYY" value="2023">

                                            <!-- <input type='year' class="form-control" id='month' name="month" title="Year" value="2022" required> -->
                                        </div>
                                    </div>
                            ...
                            <table class="table table-bordered" id="align" style="width:100% !important;">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="3" style="width:304px !important;">Strength</th>


                                        <th colspan="4" style="text-align-last: justify !important;">
                                            <button class="previous round1" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < 
                                            </button>

                                                    <span id="month_label1">Month1-(JAN)</span> <button class="next round1" id="next" onclick="navigation(event)">></button>
                                        </th>
                            ...
                            <table class="table table-bordered" id="align2" style="width:100% !important;">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="3" style="width:304px !important;">Stretch</th>
                                        <th colspan="4" style="text-align-last: justify !important;">
                                            <button class="previous round2" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < </button>
                                                    <span id="month_label2">Month1-(JAN)</span> <button class="next round2" value="1" id="next" onclick="navigation(event)">></button>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="1">week1</th>
                            ...
                            <table class="table table-bordered" id="align3" style="width:100% !important;">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="3" style="width:310px !important;">Opportunites</th>

                                        <th colspan="4" style="text-align-last: justify !important;">
                                            <button class="previous round3" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < </button>
                                                    <span id="month_label3">Month1-(JAN)</span> <button class="next round3" id="next" onclick="navigation(event)">></button>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="1">week1</th>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="align4" style="width:100% !important;">
                                <thead>
                                    ...
                                    <tr>
                                        <th colspan="4" style="text-align-last: justify !important;">
                                            <button class="previous round4" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < </button>
                                                    <span id="month_label4">Month1-(JAN)</span> <button class="next round4" id="next" onclick="navigation(event)">></button>
                                        </th>
                                    </tr>
                                    <tr>
                            ...
                            <table class="table table-bordered" id="align5" style="width:100% !important;">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="6" style="width:304px !important;">Vitals</th>
                                    </tr>
                                    <tr>
                                        <th colspan="4" style="text-align-last: justify !important;">
                                            <button class="previous round5" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < </button>
                                                    <span id="month_label5">Month1-(JAN)</span> <button class="next round5" id="next" onclick="navigation(event)">></button>
                                        </th>
                                    <tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr id="135" class="custom">
                                        ...
                                        <td class="" style="width:444px !important;font-weight: 900;font-size: 17px;">Sleep routine</td>
                            ...
                            <table class="table table-bordered" id="align6" style="width:100% !important;">
                                <thead>
                                    ...
                                    <!-- <tr>
                                        ...
                                        <th rowspan="6">Environmental</th>

                                    </tr> -->


                                    <tr>
                                        <th colspan="6" style="text-align-last: justify !important;">
                                            <button class="previous round6" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < </button>
                                                    <span id="month_label6">Month1-(JAN)</span> <button class="next round6" id="next" onclick="navigation(event)">></button>
                                        </th>
                                    <tr>
                    ...
                    <div class=" col-12 scrollable fixTableHead title-padding">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="align7" style="width:100% !important;">
                                <thead>
                                    <!-- <tr>
                                        <th rowspan="5">Emotional</th>
                                    </tr> -->
                                    <tr>
                                        <th colspan="6" style="text-align-last: justify !important;">
                                            <button class="previous round7" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < </button>
                                                    <span id="month_label7">Month1-(JAN)</span> <button class="next round7" id="next" onclick="navigation(event)">></button>
                                        </th>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="align8" style="width:100% !important;">
                                <thead>
                                    ...
                                    <tr>
                                        <th colspan="7" style="text-align-last: justify !important;">
                                            <button class="previous round8" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < </button>
                                                    <span id="month_label8">Month1-(JAN)</span> <button class="next round8" id="next" onclick="navigation(event)">></button>
                                        </th>
                    ...
                    <div class=" col-12 scrollable fixTableHead title-padding">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="align9" style="width:100% !important;">
                                <thead>
                                    <!-- <tr>
                                        <th rowspan="5">Physiological</th>
                                    </tr> -->
                                    <tr>
                                        <th colspan="6" style="text-align-last: justify !important;">
                                            <button class="previous round9" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < </button>
                                                    <span id="month_label9">Month1-(JAN)</span> <button class="next round9" id="next" onclick="navigation(event)">></button>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th>Physiological</th>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="align10" style="width:100% !important;">
                                <thead>
                                    <tr>
                                        <th colspan="4" style="text-align-last: justify !important;">
                                            <button class="previous round10" style="visibility: hidden !important;" onclick="navigation(event)">
                                                < </button>
                                                    <span id="month_label10">Month1-(JAN)</span> <button class="next round10" id="next" onclick="navigation(event)">></button>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th>Psychological</th>
    ...
    <input type="hidden" class="count" id="count1" value="1">
    <input type="hidden" class="count" id="count2" value="1">
    <input type="hidden" class="count" id="count3" value="1">
    <input type="hidden" class="count" id="count4" value="1">
    <input type="hidden" class="count" id="count5" value="1">
    <input type="hidden" class="count" id="count6" value="1">
    <input type="hidden" class="count" id="count7" value="1">
    <input type="hidden" class="count" id="count8" value="1">
    <input type="hidden" class="count" id="count9" value="1">
    <input type="hidden" class="count" id="count10" value="1">
...
<script>
    function navigation(e) {
        ...
        var current_id = document.querySelector('#current_id').value;
//alert(current_id);
        let id = `.next.round${current_id}`;
        //alert(id);
        let count = document.querySelector(`#count${current_id}`).value;
        //alert(count);
        if (e.target.classList[0] == 'previous') {
            count = --count;
            //count = value - 1;
            document.querySelector(`#count${current_id}`).value = count;
            if(count<1 ){
                return false;
            }
           // return false;
        ...
        //     let value = $(`.next.round${current_id}`).val();
        //     //alert(value);
        //     count = value - 1;
        //     //alert(count);
        ...
        document.getElementById(`month_label${current_id}`).innerHTML = '';


        if (count == 1) {
           // alert('fw');
            document.getElementById(`month_label${current_id}`).innerHTML = `Month${count}(JAN)`;
            document.querySelector(`.next.round${current_id}`).value = '1';
            document.querySelector(`.previous.round${current_id}`).style.visibility = 'hidden';
        ...
        if (count == 2) {
            //alert('ef');
            document.getElementById(`month_label${current_id}`).innerHTML = `Month${count}-(FEB)`;
            document.querySelector(`.next.round${current_id}`).value = '2';
            document.querySelector(`.previous.round${current_id}`).style.visibility = 'visible';
            document.querySelector(`.next.round${current_id}`).style.visibility = 'visible';
        ...
        if (count == 3) {
            document.getElementById(`month_label${current_id}`).innerHTML = `Month${count}-(MAR)`;
            document.querySelector(`.next.round${current_id}`).value = '3';
            document.querySelector(`.previous.round${current_id}`).style.visibility = 'visible';
            document.querySelector(`.next.round${current_id}`).style.visibility = 'visible';
        ...
        if (count == 4) {
            document.getElementById(`month_label${current_id}`).innerHTML = `Month${count}-(APR)`;
            document.querySelector(`.next.round${current_id}`).value = '4';
            document.querySelector(`.previous.round${current_id}`).style.visibility = 'visible';
            document.querySelector(`.next.round${current_id}`).style.visibility = 'visible';
        ...
        if (count == 5) {
            document.getElementById(`month_label${current_id}`).innerHTML = `Month${count}-(MAY)`;
            document.querySelector(`.next.round${current_id}`).value = '5';
            document.querySelector(`.previous.round${current_id}`).style.visibility = 'visible';
            document.querySelector(`.next.round${current_id}`).style.visibility = 'visible';
        ...
        if (count == 6) {
            document.getElementById(`month_label${current_id}`).innerHTML = `Month${count}-(JUN)`;
            document.querySelector(`.next.round${current_id}`).value = '6';
            document.querySelector(`.previous.round${current_id}`).style.visibility = 'visible';
            document.querySelector(`.next.round${current_id}`).style.visibility = 'visible';
        ...
        if (count == 7) {
            document.getElementById(`month_label${current_id}`).innerHTML = `Month${count}-(JUL)`;
            document.querySelector(`.next.round${current_id}`).value = '7';
            document.querySelector(`.previous.round${current_id}`).style.visibility = 'visible';
            document.querySelector(`.next.round${current_id}`).style.visibility = 'visible';
        ...
        if (count == 8) {
            document.getElementById(`month_label${current_id}`).innerHTML = `Month${count}-(AUG)`;
            document.querySelector('.previous').style.visibility = 'visible';
            document.querySelector(`.next.round${current_id}`).style.visibility = 'hidden';
            document.querySelector(`.next.round${current_id}`).value = '8';
