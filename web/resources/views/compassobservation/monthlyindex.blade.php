...
<div class="main-content">
    ...
    <section class="section">
        ...
        <div class="section-body mt-2">
          ...
          -->
                <div class="col-lg-12 text-center">
                    <h4 style="color:darkblue;">Monthly Observation</h4>
                </div>
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <option>EN/2022/12/025</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" id="is_coordinator1" name="is_coordinator1" value="Robert" style="background-color: rgb(128 128 128 / 34%) !important;" required autocomplete="off">
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <input type='text' class="form-control" id='month' name="month" title="Month" value="Month1 12-2022" style="background-color: rgb(128 128 128 / 34%) !important;" required autocomplete="off">
                                        </div>
        ...
        <div class="offset-10 col-2">
            ...
            <a type="button" onclick="send()" id="submitbutton" class="btn btn-labeled btn-succes" title="Observation" style="background-color:green !important;color:white !important;">
                <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-calendar"></i></span>Observation</a>
        </div>
                                    ...
                                    <tr>
                                        <td class="" style="background-color:limegreen !important;color:white !important;">Month1(December)
                                            <div class="tablesize" style="width: 50px;">
                                                ...
                                                <a class="btn btn-labeled" title="observation" href="{{ route('monthlytab') }}" style="width: 182px;height: 25px;background:blue;color:white;">4/4
                                                </a>

                                            </div>
                                        </td>
                                        <td class="" style="background-color:grey !important;color:white !important;">Month2(January)</td>
                                        <td class="" style="background-color:grey !important;color:white !important;">Month3(Feburary)</td>
                                        <td class="" style="background-color:grey !important;color:white !important;">Month4(March)</td>
...
<script>
  ...
  {
    window.location.href = "/overallmonthlycompassobservation";
  }
</script>
