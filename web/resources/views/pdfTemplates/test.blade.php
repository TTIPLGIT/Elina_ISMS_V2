...
<body>
	<div class="invoice-box">
		<table cellpadding="0" cellspacing="0">
				...
				<td colspan="5">
					<table>
						<tr>
							...
							<td>
								<br />
								<h2>INVOICE<br /># ESIS-I-2024/377</h2>
							</td>
						</tr>
					</table>
				</td>
				...
				<td colspan="5">
					<table>
						<tr>
							...
							<td>
								<b>Invoice Date: 07-09-2024</b><br />
			...
			<tr class="details">
				<td>1</td>
				<td style="text-align: left !important;"><b>SAIL</b>
					SAIL (Setting up Access for Independence and Learning ) is our program
					through which we understand the needs of a child through a functional
					assessment and provide personalised recommendations of the best suited
					learning environment for the child based on our observations of the child</td>
				<td>1.00</td>
			...
			<tr class="item">
				<td colspan="3"></td>
				<td>Payment Made </td>
				<td style="color: red;">(-) {{$data['register_fee']}}.00</td>
			</tr>
