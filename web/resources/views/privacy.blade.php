...
<body class="bgimg">
 ...
 <!--        
  <div class="col-md-1" ><img class="" style="width: 100%;
    display: block;
    margin: 15px;
    text-align: center;
    align-items: center;
    padding: 0;" src="{{ asset('images/fia_logo.png') }}"></div> -->
    <div class="col-md-12" style="justify-content: center;
    display: flex;align-items: center;"><h2 style="color:#FFF;font-size: 40px!important">Electronic Document and Records Management System</h2></div>
