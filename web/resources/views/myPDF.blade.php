...
<body style="font-family: 'Barlow', sans-serif;">
  <div class="flyleaf" style="font-family: 'Barlow', sans-serif;">
    <!-- <div class="flyleaf">
    <header>
      <img src="C:\Apache24\htdocs\Elina ISMS\v1\web\public\images/report_header.JPG" alt="" style="width: 100%;" id="img_logo">
    </header>
    <img src="C:\Apache24\htdocs\Elina ISMS\v1\web\public\images/SAIL.png" alt="" style="display: block;margin-left: auto;margin-right: auto;margin-top: 6cm;width: 50%;">
    <h6 style="text-align: center;font-size: 20px;">Child Name</h6>
    <h6 style="float:left;font-size: 20px;">Date of Birth</h6>
    <h6 style="float:right;font-size: 20px;">Date of Reporting</h6>
    <footer>
    ...
    <img src="C:\Apache24\htdocs\Elina ISMS\v1\web\public\images/report_header.JPG" alt="" style="width: 100%;position: fixed;
      top: 0cm;
      left: 0cm;
      right: 0cm;
      height: fit-content !important;">
