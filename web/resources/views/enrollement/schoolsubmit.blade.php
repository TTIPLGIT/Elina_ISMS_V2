...
<div class="main-content">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12 text-center " style="    margin-top: 5px;">
            ...
            <a type="button" href="{{url('schoolenroll')}}" id="submitbutton" class="btn btn-labeled btn-succes" title="Create New" style="background: green !important; border-color:green !important; color:white !important">
