...
class ParentsQuestionnaireController extends BaseController
{
	...
	{ //echo $this->decryptData($id);exit;
		try {
			$method = 'Method => ParentsQuestionnaireController => FormEdit';
	...
	public function QuestionnaireFormSubmit(Request $request)
	{
		...
		$logMethod = 'Method => ParentsQuestionnaireController => QuestionnaireFormSubmit';
		try {
	...
	{
		try {
			$method = 'Method => ParentsQuestionnaireController => GetAllSubmittedForm';
	...
	{ //echo $this->decryptData($id);exit;
		try {
			$method = 'Method => ParentsQuestionnaireController => SubmittedForm';
	...
	{
		$method = 'Method => ParentsQuestionnaireController => GraphGetdata';
		try {
