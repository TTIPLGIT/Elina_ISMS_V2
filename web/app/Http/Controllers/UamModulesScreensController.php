...
class UamModulesScreensController extends BaseController
{
    ...
    {
        try {
            $method = 'Method => DocumentReceiptCommonController => all_directorate_by_user';
            $data = array();
            $data['module_id'] = $request->module_id;
            $encryptArray = $this->encryptData($data);
            $request = array();
            $request['requestData'] = $encryptArray;
            $gatewayURL = config('setting.api_gateway_url') . '/uam_modules_screens/get_sub_module';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $module_type = $request->sub_module;
            $data = array();
            $data['screen_id'] = $request->screen_id;
            
            if($module_type != ''){
                $data['module_id'] = $request->sub_module;
            }else{
                $data['module_id'] = $request->module_id;
            }
