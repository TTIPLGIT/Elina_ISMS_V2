...
class QuestionnaireMasterCreation extends BaseController
{
    /**
    ...
    {
        try {
            $method = 'Method => QuestionnaireMasterCreation => index';
            ...
            if ($response->Status == 200 && $response->Success) {
                ...
                if ($objData->Code == 200) {
                    ...
                    return view('questionnaire_master.index', compact('rows', 'modules', 'screens', 'screen_permission'));
                }
            } else {
                $objData = json_decode($this->decryptData($response->Data));
    ...
    public function create()
    {
        // dd('create');
        try {
            $method = 'Method => QuestionnaireMasterCreation => create';
